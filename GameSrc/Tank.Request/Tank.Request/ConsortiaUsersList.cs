	...
	public class ConsortiaUsersList : IHttpHandler
	{
		...
		public void ProcessRequest(HttpContext context)
		{
			...
			try
			{
				...
				{
					ConsortiaUserInfo[] consortiaUsersPage = consortiaBussiness.GetConsortiaUsersPage(num2, num3, ref num1, num4, num5, num6, num7);
					foreach (ConsortiaUserInfo consortiaUserInfo in consortiaUsersPage)
					{
						xelement.Add(FlashUtils.CreateConsortiaUserInfo(consortiaUserInfo));
					}
					flag = true;
					str = "Success!";
				}
