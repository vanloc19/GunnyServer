		...
		public static string Bulid(HttpContext context)
		{
			...
			try
			{
				using (ProduceBussiness produceBussiness = new ProduceBussiness())
				{
					...
					foreach (NpcInfo npcInfo in allNPCInfo)
					{
						result.Add(FlashUtils.CreatNPCInfo(npcInfo));
					}
					flag = true;
					str = "Success!";
				}
			...
			return csFunction.CreateCompressXml(context, result, "NPCInfoList", isCompress: true);
		}
	}
}
