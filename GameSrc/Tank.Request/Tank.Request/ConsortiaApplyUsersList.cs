	...
	public class ConsortiaApplyUsersList : IHttpHandler
	{
		...
		public void ProcessRequest(HttpContext context)
		{
			...
			try
			{
				...
				int num7 = int.Parse(context.Request["userID"]);
				using (ConsortiaBussiness consortiaBussiness = new ConsortiaBussiness())
				{
					ConsortiaApplyUserInfo[] consortiaApplyUserPage = consortiaBussiness.GetConsortiaApplyUserPage(num2, num3, ref num1, num4, num5, num6, num7);
					foreach (ConsortiaApplyUserInfo consortiaApplyUserInfo in consortiaApplyUserPage)
					{
						xelement.Add(FlashUtils.CreateConsortiaApplyUserInfo(consortiaApplyUserInfo));
					}
					flag = true;
					str = "Success!";
				}
