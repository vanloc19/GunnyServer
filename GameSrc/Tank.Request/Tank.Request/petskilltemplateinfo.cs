		...
		public static string Bulid(HttpContext context)
		{
			...
			try
			{
				using (ProduceBussiness produceBussiness = new ProduceBussiness())
				{
					...
					foreach (PetSkillTemplateInfo skillTemplateInfo in allPetSkillTemplateInfo)
					{
						result.Add(FlashUtils.CreatePetSkillTemplate(skillTemplateInfo));
					}
					flag = true;
					str = "Success!";
				}
			...
			return csFunction.CreateCompressXml(context, result, "petskilltemplateinfo", isCompress: false);
		}
	}
}
