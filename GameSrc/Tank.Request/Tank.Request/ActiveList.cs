		...
		public static string Bulid(HttpContext context)
		{
			...
			try
			{
				using (ActiveBussiness activeBussiness = new ActiveBussiness())
				{
					...
					foreach (ActiveInfo allActive in allActives)
					{
						result.Add(FlashUtils.CreateActiveInfo(allActive));
					}
					flag = true;
					str = "Success!";
				}
			...
			return csFunction.CreateCompressXml(context, result, "ActiveList", isCompress: true);
		}
	}
}
