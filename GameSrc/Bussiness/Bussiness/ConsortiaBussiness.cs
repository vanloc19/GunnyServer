	...
	public class ConsortiaBussiness : BaseBussiness
	{
		...
		public bool RenameConsortia(int ConsortiaID, string nickName, string newNickName)
		{
			...
			catch (Exception exception)
			{
				if (BaseBussiness.log.IsErrorEnabled)
				{
					BaseBussiness.log.Error("RenameConsortia", exception);
					return flag;
				}
				return flag;
			}
		...
		public bool ConsortiaTaskUpdateDate(int consortiID, DateTime dateTask)
		{
			...
			try
			{
				...
				SqlParameters[1].Value = dateTask;
				SqlParameters[2] = new SqlParameter("@Result", SqlDbType.Int);
				SqlParameters[2].Direction = ParameterDirection.ReturnValue;
				flag = db.RunProcedure("SP_Consortia_UpdateTimeOpenTask", SqlParameters);
				flag = (int)SqlParameters[2].Value == 0;
				return flag;
			}
			catch (Exception ex)
		...
		public ConsortiaInfo[] GetRankDayOnlineConsortias()
		{
			...
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
					log.Error("GetRankDayRichesConsortias", e);
			}
			finally
			{
		...
		public void RemoveAllConsortiaBattleRank()
		{
			try
			{
				db.RunProcedure("SP_ConsortiaWarRank_RemoveAll");
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
		...
		public void ResetAllGodCardRaise()
        {
			try
            {
				db.RunProcedure("SP_Reset_GodCardRaise");
            }
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
		...
		public void RemoveAllConsortiaBattlePlayerRank()
		{
			try
			{
				db.RunProcedure("SP_ConsortiaWarPlayerRank_RemoveAll");
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
		...
		public ConsortiaWarRankInfo[] GetConsortiaWarRank()
		{
			List<ConsortiaWarRankInfo> infos = new List<ConsortiaWarRankInfo>();
			try
			{
				string sWhere = " ";
				string sOrder = "Rank";
				int total = 0;
				DataTable dt = GetPage("ConsortiaWarRank", sWhere, 1, 10, "*", sOrder, "ConsortiaID", ref total);
				foreach (DataRow dr in dt.Rows)
				{
					ConsortiaWarRankInfo info = new ConsortiaWarRankInfo();
					info.ConsortiaID = (int)dr["ConsortiaID"];
					info.ConsortiaName = (string)dr["ConsortiaName"];
					info.Rank = (int)dr["Rank"];
					info.Score = (int)dr["Score"];
					infos.Add(info);
				}
			}
			catch (Exception e)
		...
		public bool AddConsortiaBattleRank(ConsortiaWarRankInfo guild)
		{
			bool result = false;
			try
			{
				SqlParameter[] para = new SqlParameter[6];
				para[0] = new SqlParameter("@ConsortiaID", guild.ConsortiaID);
				para[1] = new SqlParameter("@ConsortiaName", guild.ConsortiaName);
				para[2] = new SqlParameter("@Rank", guild.Rank);
				para[3] = new SqlParameter("@Score", guild.Score);
				para[4] = new SqlParameter("@TimeCreate", guild.TimeCreate);
				para[5] = new SqlParameter("@Result", System.Data.SqlDbType.Int);
				para[5].Direction = ParameterDirection.ReturnValue;
				db.RunProcedure("SP_ConsortiaWarRank_Add", para);
		...
		public ConsortiaWarPlayerRankInfo[] GetConsortiaWarPlayerRank(int consortia)
		{
			List<ConsortiaWarPlayerRankInfo> infos = new List<ConsortiaWarPlayerRankInfo>();
			try
			{
				string sWhere = " ConsortiaID=" + consortia + " ";
				string sOrder = "Score";
				int total = 0;
				DataTable dt = GetPage("ConsortiaWarPlayerRank", sWhere, 1, 20, "*", sOrder, "UserID", ref total);
				foreach (DataRow dr in dt.Rows)
				{
					ConsortiaWarPlayerRankInfo info = new ConsortiaWarPlayerRankInfo();
					info.UserID = (int)dr["UserID"];
					info.NickName = (string)dr["NickName"];
					info.ConsortiaID = (int)dr["ConsortiaID"];
					info.Score = (int)dr["Score"];
					info.ZoneName = (string)dr["ZoneName"];
					info.ZoneID = (int)dr["ZoneID"];
					infos.Add(info);
				}
			}
			catch (Exception e)
		...
		public bool AddConsortiaBattlePlayerRank(ConsortiaWarPlayerRankInfo player)
		{
			bool result = false;
			try
			{
				SqlParameter[] para = new SqlParameter[8];
				para[0] = new SqlParameter("@UserID", player.UserID);
				para[1] = new SqlParameter("@NickName", player.NickName);
				para[2] = new SqlParameter("@ConsortiaID", player.ConsortiaID);
				para[3] = new SqlParameter("@Score", player.Score);
				para[4] = new SqlParameter("@ZoneName", player.ZoneName);
				para[5] = new SqlParameter("@ZoneID", player.ZoneID);
				para[6] = new SqlParameter("@TimeCreate", player.TimeCreate);
				para[7] = new SqlParameter("@Result", System.Data.SqlDbType.Int);
				para[7].Direction = ParameterDirection.ReturnValue;
				db.RunProcedure("SP_ConsortiaWarPlayerRank_Add", para);
		...
		public ConsortiaInfo[] GetRankDayRichesConsortias()
		{
			List<ConsortiaInfo> infos = new List<ConsortiaInfo>();
			SqlDataReader reader = null;
			try
			{
				db.GetReader(ref reader, "SP_Consortia_Rank_Day_Riches");
				while (reader.Read())
				{
					ConsortiaInfo info = new ConsortiaInfo();
					info.ConsortiaID = (int)reader["ConsortiaID"];
					...
					info.AddDayRiches = (int)reader["AddDayRiches"];
					info.AddWeekRiches = (int)reader["AddWeekRiches"];
		...
		public ConsortiaInfo[] GetRankWeekRichesConsortias()
		{
			List<ConsortiaInfo> infos = new List<ConsortiaInfo>();
			SqlDataReader reader = null;
			try
			{
				db.GetReader(ref reader, "SP_Consortia_Rank_Week_Riches");
				while (reader.Read())
				{
					ConsortiaInfo info = new ConsortiaInfo();
					info.ConsortiaID = (int)reader["ConsortiaID"];
			...
			{
				if (log.IsErrorEnabled)
					log.Error("GetRankWeekRichesConsortias", e);
			}
			finally
			{
				if (reader != null && !reader.IsClosed)
