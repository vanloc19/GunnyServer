...
namespace Road.Flash
{
	public class FlashUtils
	{
		...
		{
			return new XElement("Item", new XAttribute("ActivityType", info.ActivityType), new XAttribute("Quality", info.Quality), new XAttribute("TemplateID", info.TemplateID), new XAttribute("ValidDate", info.ValidDate), new XAttribute("Count", info.Count), new XAttribute("IsBind", info.IsBind), new XAttribute("StrengthLevel", info.StrengthLevel), new XAttribute("AttackCompose", info.AttackCompose), new XAttribute("DefendCompose", info.DefendCompose), new XAttribute("AgilityCompose", info.AgilityCompose), new XAttribute("LuckCompose", info.LuckCompose));
		}

		public static XElement CreateClothPropertyTemplateItems(ClothPropertyTemplateInfo info)
		{
			return new XElement("Item", new XAttribute("ID", info.ID), new XAttribute("Sex", info.Sex), new XAttribute("Name", info.Name), new XAttribute("Attack", info.Attack), new XAttribute("Defend", info.Defend), new XAttribute("Agility", info.Agility), new XAttribute("Luck", info.Luck), new XAttribute("Damage", info.Damage), new XAttribute("Guard", info.Guard), new XAttribute("Blood", info.Blood), new XAttribute("Cost", info.Cost), new XAttribute("Type", info.Type));
		}

		public static XElement CreateClothGroupTemplateItems(ClothGroupTemplateInfo info)
		{
			return new XElement("Item", new XAttribute("ID", info.ID), new XAttribute("TemplateID", info.TemplateID), new XAttribute("Description", info.Description), new XAttribute("Cost", info.Cost), new XAttribute("Sex", info.Sex), new XAttribute("Type", info.Type), new XAttribute("OtherTemplateID", string.IsNullOrEmpty(info.OtherTemplateID) ? "" : info.OtherTemplateID));
		}

		public static XElement CreateGmActivity(GmActivityInfo gm)
		{
			return new XElement("Activity", new XAttribute("activityId", gm.activityId),
											new XAttribute("activityName", gm.activityName),
											new XAttribute("activityType", gm.activityType),
											new XAttribute("activityChildType", gm.activityChildType),
											new XAttribute("getWay", gm.getWay),
											new XAttribute("desc", gm.desc),
											new XAttribute("rewardDesc", gm.rewardDesc),
											new XAttribute("beginTime", gm.beginTime.ToString("yyyy-MM-dd HH:mm:ss")),
											new XAttribute("beginShowTime", gm.beginShowTime.ToString("yyyy-MM-dd HH:mm:ss")),
											new XAttribute("endTime", gm.endTime.ToString("yyyy-MM-dd HH:mm:ss")),
											new XAttribute("endShowTime", gm.endShowTime.ToString("yyyy-MM-dd HH:mm:ss")),
											new XAttribute("icon", gm.icon),
											new XAttribute("isContinue", gm.isContinue),
											new XAttribute("status", gm.status),
											new XAttribute("remain1", gm.remain1),
											new XAttribute("remain2", gm.remain2)
				);
		}

		public static XElement CreateGmGift(GmGiftInfo gm)
		{
			return new XElement("Gift", new XAttribute("giftbagId", gm.giftbagId),
											new XAttribute("activityId", gm.activityId),
											new XAttribute("rewardMark", gm.rewardMark),
											new XAttribute("giftbagOrder", gm.giftbagOrder)
				);
		}

		public static XElement CreateGmActiveReward(GmActiveRewardInfo gm)
		{
			return new XElement("Reward", new XAttribute("giftId", gm.giftId),
											new XAttribute("templateId", gm.templateId),
											new XAttribute("count", gm.count),
											new XAttribute("isBind", gm.isBind ? "1" : "0"),
											new XAttribute("occupationOrSex", gm.occupationOrSex),
											new XAttribute("rewardType", gm.rewardType),
											new XAttribute("validDate", gm.validDate),
											new XAttribute("property", gm.property),
											new XAttribute("remain1", gm.remain1)
				);
		}

		public static XElement CreateGmActiveCondition(GmActiveConditionInfo gm)
		{
			return new XElement("Condition", new XAttribute("giftbagId", gm.giftbagId),
											new XAttribute("conditionIndex", gm.conditionIndex),
											new XAttribute("conditionValue", gm.conditionValue),
											new XAttribute("remain1", gm.remain1),
											new XAttribute("remain2", gm.remain2 == null ? "" : gm.remain2)
				);
		}
		...
		{
			return new XElement("Item", new XAttribute("ID", id), new XAttribute("Name", name), new XAttribute("IP", ip), new XAttribute("Port", port), new XAttribute("State", state), new XAttribute("MustLevel", mustLevel), new XAttribute("LowestLevel", lowestLevel), new XAttribute("Online", online), new XAttribute("Remark", ""));
		}
		...
		{
			return new XElement("Item", new XAttribute("ID", m.ID), new XAttribute("Name", (m.Name == null) ? "" : m.Name), new XAttribute("Type", m.Type), new XAttribute("LevelLimits", m.LevelLimits), new XAttribute("SimpleTemplateIds", (m.SimpleTemplateIds == null) ? "" : m.SimpleTemplateIds), new XAttribute("NormalTemplateIds", (m.NormalTemplateIds == null) ? "" : m.NormalTemplateIds), new XAttribute("HardTemplateIds", (m.HardTemplateIds == null) ? "" : m.HardTemplateIds), new XAttribute("TerrorTemplateIds", (m.TerrorTemplateIds == null) ? "" : m.TerrorTemplateIds), new XAttribute("Pic", (m.Pic == null) ? "" : m.Pic), new XAttribute("Description", (m.Description == null) ? "" : m.Description), new XAttribute("Ordering", m.Ordering), new XAttribute("AdviceTips", (m.AdviceTips == null) ? "" : m.AdviceTips), new XAttribute("BossFightNeedMoney", m.BossFightNeedMoney ?? ""), new XAttribute("FightPower", m.FightPower ?? ""), new XAttribute("NightmareGameScript", m.NightmareGameScript ?? ""), new XAttribute("NightmareTemplateIds", m.NightmareTemplateIds ?? ""));
		}

		public static XElement CreateStrengthenInfo(StrengthenInfo info)
		{
			return new XElement("Item", new XAttribute("StrengthenLevel", info.StrengthenLevel), new XAttribute("Rock", info.Rock), new XAttribute("Rock1", info.Rock1), new XAttribute("Rock2", info.Rock2), new XAttribute("Rock3", info.Rock3), new XAttribute("StoneLevelMin", info.StoneLevelMin));
		}
		...
		{
			// CRITICAL FIX: Grade must be placed AFTER GP in XML attributes
			// This ensures when client copies properties from XML, Grade is copied AFTER GP
			// and will override the Grade calculated from GP (which uses online player's Grade)
			return new XElement("Item", new XAttribute("ID", info.ID), new XAttribute("UserName", (info.UserName == null) ? "" : info.UserName), new XAttribute("NickName", (info.NickName == null) ? "" : info.NickName), new XAttribute("typeVIP", info.typeVIP), new XAttribute("VIPLevel", info.VIPLevel), new XAttribute("Colors", (info.Colors == null) ? "" : info.Colors), new XAttribute("Skin", (info.Skin == null) ? "" : info.Skin), new XAttribute("Sex", info.Sex), new XAttribute("Style", (info.Style == null) ? "" : info.Style), new XAttribute("ConsortiaName", (info.ConsortiaName == null) ? "" : info.ConsortiaName), new XAttribute("Hide", info.Hide), new XAttribute("Offer", info.Offer), new XAttribute("ReputeOffer", info.ReputeOffer), new XAttribute("ConsortiaHonor", info.ConsortiaHonor), new XAttribute("ConsortiaLevel", info.ConsortiaLevel), new XAttribute("StoreLevel", info.StoreLevel), new XAttribute("ShopLevel", info.ShopLevel), new XAttribute("SmithLevel", info.SmithLevel), new XAttribute("ConsortiaRepute", info.ConsortiaRepute), new XAttribute("WinCount", info.Win), new XAttribute("TotalCount", info.Total), new XAttribute("EscapeCount", info.Escape), new XAttribute("Repute", info.Repute), new XAttribute("AddDayGP", info.AddDayGP), new XAttribute("AddDayOffer", info.AddDayOffer), new XAttribute("AddWeekGP", info.AddWeekGP), new XAttribute("AddWeekOffer", info.AddWeekOffer), new XAttribute("ConsortiaRiches", info.ConsortiaRiches), new XAttribute("Nimbus", info.Nimbus), new XAttribute("GP", info.GP), new XAttribute("Grade", info.Grade), new XAttribute("FightPower", info.FightPower), new XAttribute("AchievementPoint", info.AchievementPoint), new XAttribute("Rank", ""), new XAttribute("AddDayAchievementPoint", info.AddDayAchievementPoint), new XAttribute("AddWeekAchievementPoint", info.AddWeekAchievementPoint), new XAttribute("GiftGp", info.charmGP), new XAttribute("GiftLevel", info.charmLevel), new XAttribute("AddDayGiftGp", info.charmGP), new XAttribute("AddWeekGiftGp", info.charmGP), new XAttribute("ApprenticeshipState", 0), new XAttribute("AddWeekLeagueScore", 0));
		}
		...
		public static XElement CreatLevelList(LevelInfo info)
        {
			return new XElement("Item", new XAttribute("Grade", info.Grade), new XAttribute("GP", info.GP), new XAttribute("Blood", info.Blood));
        }
		...
		public static XElement CreatePetTemplate(PetTemplateInfo info)
        {
			return new XElement("Item", new object[]
			{
				...
				new XAttribute("KindID", info.KindID),
				new XAttribute("Description", info.Description),
				new XAttribute("Pic", info.Pic),
				new XAttribute("RareLevel", info.RareLevel),
				new XAttribute("MP", info.MP),
				new XAttribute("StarLevel", info.StarLevel),
				new XAttribute("GameAssetUrl", info.GameAssetUrl),
				new XAttribute("HighAgility", info.HighAgility),
				new XAttribute("HighAgilityGrow", info.HighAgilityGrow),
				new XAttribute("HighAttack", info.HighAttack),
				new XAttribute("HighAttackGrow", info.HighAttackGrow),
				new XAttribute("HighBlood", info.HighBlood),
				new XAttribute("HighBloodGrow", info.HighBloodGrow),
				new XAttribute("HighDamage", info.HighDamage),
				new XAttribute("HighDamageGrow", info.HighDamageGrow),
				new XAttribute("HighDefence", info.HighDefence),
				new XAttribute("HighDefenceGrow", info.HighDefenceGrow),
				new XAttribute("HighGuard", info.HighGuard),
				new XAttribute("HighGuardGrow", info.HighGuardGrow),
				new XAttribute("HighLuck", info.HighLuck),
				new XAttribute("HighLuckGrow", info.HighLuckGrow),
				new XAttribute("LowBloodGrow", info.LowBloodGrow),
				new XAttribute("LowAttackGrow", info.LowAttackGrow),
				new XAttribute("LowDefenceGrow", info.LowDefenceGrow),
				new XAttribute("LowAgilityGrow", info.LowAgilityGrow),
				new XAttribute("LowLuckGrow", info.LowLuckGrow),
				new XAttribute("WashGetCount", info.WashGetCount)
			});
		}

		public static XElement CreateGodCardGroup(GodCardGroupInfo info)
		{
			return new XElement("Item", new XAttribute("GroupID", info.GroupID),
				new XAttribute("GroupName", string.IsNullOrEmpty(info.GroupName) ? "" : info.GroupName),
				new XAttribute("ExchangeTimes", info.ExchangeTimes), new XAttribute("GiftID", info.GiftID));
		}

		public static XElement CreateGodCardGroupDetail(GodCardGroupDetailInfo info)
		{
			return new XElement("ItemDetail", new XAttribute("CardID", info.CardID),
				new XAttribute("Number", info.Number));
		}

		public static XElement CreateGodCard(GodCardInfo info)
		{
			return new XElement("Item", new XAttribute("ID", info.ID),
				new XAttribute("Name", string.IsNullOrEmpty(info.Name) ? "" : info.Name), new XAttribute("Pic", info.Pic),
				new XAttribute("Composition", info.Composition), new XAttribute("Decompose", info.Decompose),
				new XAttribute("Level", info.Level));
		}

		public static XElement CreateGodCardPointReward(GodCardPointRewardInfo info)
		{
			return new XElement("Item", new XAttribute("ID", info.ID), new XAttribute("Count", info.Count),
				new XAttribute("IsBind", info.IsBind), new XAttribute("ItemID", info.ItemID),
				new XAttribute("Point", info.Point), new XAttribute("Valid", info.Valid));
		}

		public static XElement CreateActiveConditionInfo(SubActiveConditionInfo info)
		{
			return new XElement("Condition", new XAttribute("ActiveID", info.ActiveID), new XAttribute("SubID", info.SubID), new XAttribute("ConditionID", info.ConditionID), new XAttribute("Type", info.Type), new XAttribute("Value", info.Value), new XAttribute("AwardType", info.AwardType), new XAttribute("AwardValue", info.AwardValue ?? ""), new XAttribute("IsValid", info.IsValid));
		}

		public static XElement CreateActiveInfo(SubActiveInfo info)
		{
			return new XElement("Active", new XAttribute("ActiveID", info.ActiveID), new XAttribute("SubID", info.SubID), new XAttribute("IsOpen", info.IsOpen), new XAttribute("StartDate", info.StartDate.ToString("yyyy-MM-dd HH:mm:ss")), new XAttribute("StartTime", info.StartTime.ToString("yyyy-MM-dd HH:mm:ss")), new XAttribute("EndDate", info.EndDate.ToString("yyyy-MM-dd HH:mm:ss")), new XAttribute("EndTime", info.EndTime.ToString("yyyy-MM-dd HH:mm:ss")), new XAttribute("IsContinued", info.IsContinued), new XAttribute("ActiveInfo", info.ActiveInfo ?? ""));
		}

		public static XElement CreateAccumulAtiveLoginAward(AccumulAtiveLoginAwardInfo info)
        {
			return new XElement("Item", new XAttribute("ID", info.ID), new XAttribute("Count", info.Count), new XAttribute("RewardItemID", info.RewardItemID), new XAttribute("IsSelect", info.IsSelect), new XAttribute("IsBind", info.IsBind), new XAttribute("RewardItemValid", info.RewardItemValid), new XAttribute("RewardItemCount", info.RewardItemCount), new XAttribute("StrengthenLevel", info.StrengthenLevel), new XAttribute("AttackCompose", info.AttackCompose), new XAttribute("DefendCompose", info.DefendCompose), new XAttribute("AgilityCompose", info.AgilityCompose), new XAttribute("LuckCompose", info.LuckCompose));
        }

		public static XElement CreateMiniGameShop(MinigameShopTemplateInfo info)
        {
			return new XElement("Item", new XAttribute("Count", info.Count), new XAttribute("IsBind", info.IsBind), new XAttribute("ItemID", info.ItemID), new XAttribute("Price", info.Price), new XAttribute("LimitCount", info.LimitCount), new XAttribute("Type", info.Type), new XAttribute("Valid", info.Valid));
        }

		public static XElement CreateThreeCleanPointAward(ThreeClearPointAwardInfo info)
        {
			return new XElement("Item", new XAttribute("Count", info.Count), new XAttribute("ID", info.ID), new XAttribute("IsBind", info.IsBind), new XAttribute("ItemID", info.ItemID), new XAttribute("Point", info.Point), new XAttribute("Type", info.Type), new XAttribute("Valid", info.Valid));
        }

		public static XElement CreateNewTitleInfo(NewTitleInfo info)
        {
			return new XElement("Item", new XAttribute("ID", info.ID), new XAttribute("Order", info.Order), new XAttribute("Show", info.Show), new XAttribute("Name", info.Name), new XAttribute("Pic", info.Pic), new XAttribute("Att", info.Att), new XAttribute("Def", info.Def), new XAttribute("Agi", info.Agi), new XAttribute("Luck", info.Luck), new XAttribute("Desc", info.Desc));
        }

		public static XElement CreateTotemInfo(TotemInfo info)
		{
			return new XElement("item", new XAttribute("ID", info.ID), new XAttribute("ConsumeExp", info.ConsumeExp), new XAttribute("ConsumeHonor", info.ConsumeHonor), new XAttribute("AddAttack", info.AddAttack), new XAttribute("AddDefence", info.AddDefence), new XAttribute("AddAgility", info.AddAgility), new XAttribute("AddLuck", info.AddLuck), new XAttribute("AddBlood", info.AddBlood), new XAttribute("AddDamage", info.AddDamage), new XAttribute("AddGuard", info.AddGuard), new XAttribute("Random", info.Random), new XAttribute("Page", info.Page), new XAttribute("Layers", info.Layers), new XAttribute("Location", info.Location), new XAttribute("Point", info.Point), new XAttribute("DiscountMoney", info.DiscountMoney));
		}

		public static XElement Createfightspirittemplatelist(FightSpiritTemplateInfo info)
		{
			return new XElement("item", new XAttribute("FightSpiritID", info.FightSpiritID), new XAttribute("FightSpiritIcon", info.FightSpiritIcon), new XAttribute("Level", info.Level), new XAttribute("Exp", info.Exp), new XAttribute("Attack", info.Attack), new XAttribute("Defence", info.Defence), new XAttribute("Agility", info.Agility), new XAttribute("Lucky", info.Lucky), new XAttribute("Blood", info.Blood));
		}

		public static XElement CreateDailyLeagueLevelInfo(DailyLeagueLevelInfo info)
		{
			return new XElement("item", new object[]
			{
				new XAttribute("Name", info.Name),
				new XAttribute("Level", info.Level),
				new XAttribute("Score", info.Score),
			});
		}

		public static XElement CreateDailyLeagueAwardInfo(DailyLeagueAwardInfo info)
		{
			return new XElement("item", new object[]
			{
				new XAttribute("Level", info.Level),
				...
				new XAttribute("LevHole6el", info.Hole6),
