...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1196 : BasePetEffect
    {
        ...
        {
            AE1196 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1196) as AE1196;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1196(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
