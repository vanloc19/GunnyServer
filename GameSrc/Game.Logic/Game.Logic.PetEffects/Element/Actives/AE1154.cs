...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1154 : BasePetEffect
    {
        ...
        {
            AE1154 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1154) as AE1154;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1154(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}