...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1247 : BasePetEffect
    {
        ...
        {
            AE1247 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1247) as AE1247;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1247(0, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}