...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1063 : BasePetEffect
    {
        ...
        {
            AE1063 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1063) as AE1063;
            if (effect != null)
            {
        ...
        private void Player_PlayerBuffSkillPet(Player player)
        {
            if (player.PetEffects.CurrentUseSkill == m_currentId)
            {
                ...
                player.AddPetEffect(new CE1063(4, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
