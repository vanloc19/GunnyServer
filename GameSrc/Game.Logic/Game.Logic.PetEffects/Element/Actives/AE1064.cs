...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1064 : BasePetEffect
    {
        ...
        {
            AE1064 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1064) as AE1064;
            if (effect != null)
            {
        ...
        private void Player_PlayerBuffSkillPet(Player player)
        {
            if (player.PetEffects.CurrentUseSkill == m_currentId)
            {
                ...
                player.AddPetEffect(new CE1064(4, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
