...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1153 : BasePetEffect
    {
        ...
        {
            AE1153 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1153) as AE1153;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1153(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
