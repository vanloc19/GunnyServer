...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1017 : BasePetEffect
    {
        ...
        {
            AE1017 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1017) as AE1017;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1017(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}