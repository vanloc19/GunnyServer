...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1229 : BasePetEffect
    {
        ...
        {
            AE1229 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1229) as AE1229;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1229(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
