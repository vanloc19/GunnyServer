...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1115 : BasePetEffect
    {
        ...
        {
            AE1115 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1115) as AE1115;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(new CE1115(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}