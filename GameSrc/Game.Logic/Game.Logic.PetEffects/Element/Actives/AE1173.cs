...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1173 : BasePetEffect
    {
        ...
        {
            AE1173 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1173) as AE1173;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1173(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
