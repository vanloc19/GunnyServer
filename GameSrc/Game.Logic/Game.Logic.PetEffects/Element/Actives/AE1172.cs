...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1172 : BasePetEffect
    {
        ...
        {
            AE1172 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1172) as AE1172;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1172(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
