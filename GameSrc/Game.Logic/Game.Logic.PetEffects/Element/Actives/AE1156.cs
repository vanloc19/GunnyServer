...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1156 : BasePetEffect
    {
        ...
        {
            AE1156 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1156) as AE1156;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1156(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
