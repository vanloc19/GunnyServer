...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1045 : BasePetEffect
    {
        ...
        {
            AE1045 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1045) as AE1045;
            if (effect != null)
            {
        ...
        private void Player_PlayerBuffSkillPet(Player player)
        {
            if (player.PetEffects.CurrentUseSkill == m_currentId)
            {
                ...
                player.AddPetEffect(
                    new CE1045(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
