...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1026 : BasePetEffect
    {
        ...
        {
            AE1026 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1026) as AE1026;
            if (effect != null)
            {
        ...
        private void Player_PlayerBuffSkillPet(Player player)
        {
            if (player.PetEffects.CurrentUseSkill == m_currentId)
            {
                ...
                player.AddPetEffect(new CE1026(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
