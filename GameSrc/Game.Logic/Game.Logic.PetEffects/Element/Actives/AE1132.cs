...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1132 : BasePetEffect
    {
        ...
        {
            AE1132 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1132) as AE1132;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(new CE1132(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}