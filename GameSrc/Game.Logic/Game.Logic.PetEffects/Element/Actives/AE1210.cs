...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1210 : BasePetEffect
    {
        ...
        {
            AE1210 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1210) as AE1210;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1210(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
