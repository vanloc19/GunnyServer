...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1246 : BasePetEffect
    {
        ...
        {
            AE1246 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1246) as AE1246;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1246(0, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}