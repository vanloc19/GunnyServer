...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1175 : BasePetEffect
    {
        ...
        {
            AE1175 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1175) as AE1175;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1175(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
