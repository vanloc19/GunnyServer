...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1211 : BasePetEffect
    {
        ...
        {
            AE1211 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1211) as AE1211;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1211(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
