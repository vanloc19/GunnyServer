...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1027 : BasePetEffect
    {
        ...
        {
            AE1027 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1027) as AE1027;
            if (effect != null)
            {
        ...
        private void Player_PlayerBuffSkillPet(Player player)
        {
            if (player.PetEffects.CurrentUseSkill == m_currentId)
            {
                ...
                player.AddPetEffect(new CE1027(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
