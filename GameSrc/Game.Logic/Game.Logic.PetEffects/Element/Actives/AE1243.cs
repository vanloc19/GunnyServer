...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1243 : BasePetEffect
    {
        ...
        {
            AE1243 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1243) as AE1243;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1243(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
