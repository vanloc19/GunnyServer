...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1248 : BasePetEffect
    {
        ...
        {
            AE1248 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1248) as AE1248;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1248(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}