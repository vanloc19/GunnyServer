    ...
    public class AE1222 : BasePetEffect
    {
        ...
        private void Player_AfterKillingLiving(Living living, Living target, int damageAmount, int criticalAmount)
        {
            if (IsTrigger)
            {
                ...
                target.AddPetEffect(
                    new CE1222(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
                IsTrigger = false;
            }
        }
                ...
                switch (m_currentId)
                {
                    ...
                    case 155:
                        ...
                        foreach (Player enemy in Enemies)
                        {
                            ...
                            enemy.AddPetEffect(
                                new CE1222(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()),
                                0);
                        }
