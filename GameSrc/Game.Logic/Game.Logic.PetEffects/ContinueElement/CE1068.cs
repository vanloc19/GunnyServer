...
namespace Game.Logic.PetEffects.ContinueElement
{
    public class CE1068 : BasePetEffect
    {
        ...
        {
            CE1068 effect = living.PetEffectList.GetOfType(ePetEffectType.CE1068) as CE1068;
            if (effect != null)
            {
            ...
            if (IsTrigger)
            {
                ...
                if (target.Blood <= 0)
                {
                    ...
                    if (living != null && living is Player)
                        (living as Player).PlayerDetail.OnKillingLiving(living.Game, 2, target.Id, target.IsLiving,
                            m_added);
                }
