...
namespace Game.Logic.PetEffects.ContinueElement
{
    public class CE1270 : BasePetEffect
    {
        ...
        {
            CE1270 effect = living.PetEffectList.GetOfType(ePetEffectType.CE1270) as CE1270;
            if (effect != null)
            {
            ...
            else
            {
                ...
                if (living.Blood <= 0)
                {
                    ...
                    if (m_liv != null && m_liv is Player)
                        (m_liv as Player).PlayerDetail.OnKillingLiving(m_liv.Game, 2, living.Id, living.IsLiving,
                            m_added);
                }
            }
        }
