...
namespace Game.Logic.Phy.Object
{
	public class SimpleNpc : Living
	{
		...
		public override void Die()
		{
            ...
            {
				ilog_1.ErrorFormat("SimpleNPC Die Error: {1}", ex);
            }
		}
		...
		public override void Die(int delay)
		{
			GetDropItemInfo();
			base.Die(delay);
			this.abrain_0.OnDieAction(null);
			try
			{
				this.abrain_0.OnDie();
			}
			...
			{
				ilog_1.ErrorFormat("SimpleNpc1 Die error:{1}", (object)ex);
			}
		}
		...
		public override void OnHeal(int blood)
		{
			...
			{
				ilog_1.ErrorFormat("SimpleNpc OnHeal error:{0}", (object)ex);
			}
			base.OnHeal(blood);
		}
		...
		{
			this.abrain_0.OnTakedDameAction();
		}
