namespace SqlDataProvider.Data
{
    public class PyramidInfo : DataObject
    {
        ...
        private int _currentCountNow;

        public int currentCountNow
        {
            get { return _currentCountNow; }
            set
            {
                _currentCountNow = value;
                _isDirty = true;
            }
        }
        ...
        {
            get { return _currentReviveCount; }
            set
            {
