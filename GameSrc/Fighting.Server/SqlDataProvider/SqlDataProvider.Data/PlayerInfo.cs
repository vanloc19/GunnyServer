...
namespace SqlDataProvider.Data
{
	public class PlayerInfo : DataObject
	{
		...
		private int m_necklaceExp;

		private int m_necklaceExpAdd;

		private int _ringExp;
		
		public int gameUpToCaptcha
		{
			get;
			set;
		}
        ...
        {
			get { return _LoginDevice; }
			set { _LoginDevice = value; }
        }

		public DateTime LastRefreshPet
		{
			get { return m_LastRefreshPet; }
			set
			{
		...
		private Dictionary<int, string> _masterOrApprenticesArr
		{
			get;
			set;
		}
		...
		{
			get { return _accumulativeLoginDays; }
			set
            {
        ...
        {
			get { return _accumulativeAwardDays; }
			set
            {
		...
		public int ReduceStartBlood { set; get; }

		public bool ActivePowFirstGame { get; set; }

		public int AgiPlusGuildBattle { get; set; }

		public int AttPlusGuildBattle { get; set; }

		public int TotalMoneyFastForWard
        {
			get;
			set;
        }

		public int EliteHpEndMatch { get; set; }

		public int MaxBuyHonor
		{
			get { return _maxBuyHonor; }
			set
			{
				_maxBuyHonor = value;
				_isDirty = true;
		...
		public int necklaceExpAdd
        {
			get
            {
				return m_necklaceExpAdd;
            }
			set
            {
				m_necklaceExpAdd = value;
				_isDirty = true;
            }
        }
		...
		private int m_fineSuitExp;

		private string _GhostEquipList;

		private int _damageScores;

		private DateTime _dateFinishTask;

		public int fineSuitExp
		{
			get { return m_fineSuitExp; }
			set { m_fineSuitExp = value; }
		}

		public string GhostEquipList
		{
			get { return _GhostEquipList; }
			set
			{
				_GhostEquipList = value;
				_isDirty = true;
			}
		}

		public int damageScores //WorldBoss Damage Score
		{
			get { return _damageScores; }
			set { _damageScores = value; }
		}

		public DateTime DateFinishTask
        {
			get { return _dateFinishTask; }
			set { _dateFinishTask = value; }
        }
		...
		private int m_AwardColumnOne;
		private int m_AwardColumnTwo;
		private int m_AwardColumnThree;
		private int m_AwardColumnFour;
		private bool m_MyRewardStatus;
		private bool m_MyCodeStatus;

		public string MyInviteCode
		{
			get
			{
				return this.m_myInviteCode;
			}
			set
			{
				this.m_myInviteCode = value;
				this._isDirty = true;
			}
		}
		...
		public int MyInvitedCount
		{
			get
			{
				return this.m_MyInvitedCount;
			}
			set
			{
				this.m_MyInvitedCount = value;
				this._isDirty = true;
			}
		}

		public int AwardColumnOne
		{
			get
			{
				return this.m_AwardColumnOne;
			}
			set
			{
				this.m_AwardColumnOne = value;
				this._isDirty = true;
			}
		}

		public int AwardColumnTwo
		{
			get
			{
				return this.m_AwardColumnTwo;
			}
			set
			{
				this.m_AwardColumnTwo = value;
				this._isDirty = true;
			}
		}

		public int AwardColumnThree
		{
			get
			{
				return this.m_AwardColumnThree;
			}
			set
			{
				this.m_AwardColumnThree = value;
				this._isDirty = true;
			}
		}

		public int AwardColumnFour
		{
			get
			{
				return this.m_AwardColumnFour;
			}
			set
			{
				this.m_AwardColumnFour = value;
				this._isDirty = true;
			}
		}
		...
		public bool MyRewardStatus
		{
			get
			{
				return this.m_MyRewardStatus;
			}
			set
			{
				this.m_MyRewardStatus = value;
				this._isDirty = true;
			}
		}

		public bool MyCodeStatus
		{
			get
			{
				return this.m_MyCodeStatus;
			}
			set
			{
				this.m_MyCodeStatus = value;
				this._isDirty = true;
			}
		}
		#endregion
		...
		{
			get { return _DailyLeagueLastScore; }
			set
			{
        ...
        private ExplorerManualInfo _explorerManualInfo;
        public int jampsCurrency { get; set; }

        public ExplorerManualInfo explorerManualInfo
        {
            get { return _explorerManualInfo; }
            set { _explorerManualInfo = value; }
        }
        #endregion
        ...
        public DateTime QuitConsortiaDate
		{
			get;
			set;
		}
