...
namespace SqlDataProvider.Data
{
	public class ItemInfo : DataObject
	{
		...
		public static void FindSpecialItemInfo(ItemInfo info, SpecialItemDataInfo specialInfo)
		{
			switch (info.TemplateID)
			{
				...
				case -100:
					...
					break;
				case -2100:
					specialInfo.CrystalScore += info.Count;
					info = null;
					break;
			}
		}
		...
		public static void GetItemPrice(int Prices, int Values, decimal beat, ref int gold, ref int money, ref int offer, ref int gifttoken, ref int petScore, ref int damageScore, ref int Score, ref int iTemplateID, ref int iCount)
		{
			iTemplateID = 0;
			iCount = 0;
			switch (Prices)
		...
		public static List<int> SetItemType(ShopItemInfo shop, int type, ref int gold, ref int money, ref int offer, ref int gifttoken, ref int petScore, ref int Score, ref int damageScore)
		{
			int iTemplateID = 0;
			int iCount = 0;
			...
			if (type == 1)
			{
				GetItemPrice(shop.APrice1, shop.AValue1, shop.Beat, ref gold, ref money, ref offer, ref gifttoken, ref petScore, ref damageScore, ref Score, ref iTemplateID, ref iCount);
				if (iTemplateID > 0)
				{
					list.Add(iTemplateID);
					list.Add(iCount);
				}
				GetItemPrice(shop.APrice2, shop.AValue2, shop.Beat, ref gold, ref money, ref offer, ref gifttoken, ref petScore, ref damageScore, ref Score, ref iTemplateID, ref iCount);
				if (iTemplateID > 0)
				{
					list.Add(iTemplateID);
					list.Add(iCount);
				}
				GetItemPrice(shop.APrice3, shop.AValue3, shop.Beat, ref gold, ref money, ref offer, ref gifttoken, ref petScore, ref damageScore, ref Score, ref iTemplateID, ref iCount);
				if (iTemplateID > 0)
				{
					list.Add(iTemplateID);
					list.Add(iCount);
			...
			if (type == 2)
			{
				GetItemPrice(shop.BPrice1, shop.BValue1, shop.Beat, ref gold, ref money, ref offer, ref gifttoken, ref petScore, ref damageScore, ref Score, ref iTemplateID, ref iCount);
				if (iTemplateID > 0)
				{
					list.Add(iTemplateID);
					list.Add(iCount);
				}
				GetItemPrice(shop.BPrice2, shop.BValue2, shop.Beat, ref gold, ref money, ref offer, ref gifttoken, ref petScore, ref damageScore, ref Score, ref iTemplateID, ref iCount);
				if (iTemplateID > 0)
				{
					list.Add(iTemplateID);
					list.Add(iCount);
				}
				GetItemPrice(shop.BPrice3, shop.BValue3, shop.Beat, ref gold, ref money, ref offer, ref gifttoken, ref petScore, ref damageScore, ref Score, ref iTemplateID, ref iCount);
				if (iTemplateID > 0)
				{
					list.Add(iTemplateID);
					list.Add(iCount);
			...
			if (type == 3)
			{
				GetItemPrice(shop.CPrice1, shop.CValue1, shop.Beat, ref gold, ref money, ref offer, ref gifttoken, ref petScore, ref damageScore, ref Score, ref iTemplateID, ref iCount);
				if (iTemplateID > 0)
				{
					list.Add(iTemplateID);
					list.Add(iCount);
				}
				GetItemPrice(shop.CPrice2, shop.CValue2, shop.Beat, ref gold, ref money, ref offer, ref gifttoken, ref petScore, ref damageScore, ref Score, ref iTemplateID, ref iCount);
				if (iTemplateID > 0)
				{
					list.Add(iTemplateID);
					list.Add(iCount);
				}
				GetItemPrice(shop.CPrice3, shop.CValue3, shop.Beat, ref gold, ref money, ref offer, ref gifttoken, ref petScore, ref damageScore, ref Score, ref iTemplateID, ref iCount);
				if (iTemplateID > 0)
				{
					list.Add(iTemplateID);
					list.Add(iCount);
