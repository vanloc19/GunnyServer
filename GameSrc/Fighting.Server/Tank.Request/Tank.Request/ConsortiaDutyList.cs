	...
	public class ConsortiaDutyList : IHttpHandler
	{
		...
		public void ProcessRequest(HttpContext context)
		{
			...
			try
			{
				...
				{
					ConsortiaDutyInfo[] consortiaDutyPage = consortiaBussiness.GetConsortiaDutyPage(num2, num3, ref num1, num4, num5, num6);
					foreach (ConsortiaDutyInfo consortiaDutyInfo in consortiaDutyPage)
					{
						xelement.Add(FlashUtils.CreateConsortiaDutyInfo(consortiaDutyInfo));
					}
					flag = true;
					str = "Success!";
				}
