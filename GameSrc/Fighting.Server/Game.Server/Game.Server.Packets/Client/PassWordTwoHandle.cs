                ...
                case 1:
                    {
                        ...
                        if (string.IsNullOrEmpty(client.Player.PlayerCharacter.PasswordTwo))
                        {
                            using (PlayerBussiness db = new PlayerBussiness())
                            {
                                ...
                                if (passwordQuestion1 != "" && passwordAnswer1 != "" && passwordQuestion2 != "" &&
                                    passwordAnswer2 != "")
                                {
                                    if (db.UpdatePasswordInfo(client.Player.PlayerCharacter.ID, passwordQuestion1,
                                        passwordAnswer1, passwordQuestion2, passwordAnswer2, 5))
                                    {
                ...
                case 4:
                    {
                        ...
                        reType = 4;
                        string dbPasswordAnswer4 = "";
                        string PassWordTwo = "";
                        string dbPasswordAnswer2 = "";

                        using (PlayerBussiness pb = new PlayerBussiness())
                        {
                            pb.GetPasswordInfo(client.Player.PlayerCharacter.ID, ref passwordQuestion1, ref dbPasswordAnswer4, ref passwordQuestion2, ref dbPasswordAnswer2, ref count);
                            if (dbPasswordAnswer4 == passwordAnswer1 && dbPasswordAnswer2 == passwordAnswer2)
                            {
                                if (!pb.UpdatePasswordTwo(client.Player.PlayerCharacter.ID, PassWordTwo))
                                {
