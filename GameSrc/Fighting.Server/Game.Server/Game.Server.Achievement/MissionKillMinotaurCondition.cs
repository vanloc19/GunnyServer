...
{
	public class MissionKillMinotaurCondition : BaseUserRecord
	{
		public MissionKillMinotaurCondition(GamePlayer player, int type)
			: base(player, type)
		{
			AddTrigger(player);
		}
		...
		{
			if (game.GameType == eGameType.Dungeon && !isLiving && type == 2 && id == 4309)
			{
