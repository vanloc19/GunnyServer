...
{
    public class RankConsumeMoney : IGMActive
    {
        public RankConsumeMoney(GmActivityInfo gmActive, List<UserGmActivityInfo> listUsersGmInfo) : base(gmActive, listUsersGmInfo)
        {
        }
        ...
        {
            GmActivityMgr.ConsumeMoney += GmActivityMgr_ConsumeMoney;
        }

        private void GmActivityMgr_ConsumeMoney(GamePlayer player, int value)
        {
