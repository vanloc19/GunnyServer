...
{
    public class PetEvolution : IGMActive
    {
        public PetEvolution(GmActivityInfo gmActive, List<UserGmActivityInfo> listUsersGmInfo) : base(gmActive, listUsersGmInfo)
        {
        }
        ...
        {
            GmActivityMgr.Evolution += GmActivityMgr_Evolution;
        }

        private void GmActivityMgr_Evolution(GamePlayer player, int value)
        {
