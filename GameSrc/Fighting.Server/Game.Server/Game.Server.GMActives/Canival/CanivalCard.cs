...
{
    public class CanivalCard : IGMActive
    {
        public CanivalCard(GmActivityInfo gmActive, List<UserGmActivityInfo> listUsersGmInfo) : base(gmActive, listUsersGmInfo)
        {
        }
        ...
        {
            GmActivityMgr.CardUp += GmActivityMgr_CardUp;
        }

        private void GmActivityMgr_CardUp(GamePlayer player, int value)
        {
