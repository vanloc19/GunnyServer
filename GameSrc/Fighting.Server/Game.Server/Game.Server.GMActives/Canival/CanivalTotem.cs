...
{
    public class CanivalTotem : IGMActive
    {
        public CanivalTotem(GmActivityInfo gmActive, List<UserGmActivityInfo> listUsersGmInfo) : base(gmActive, listUsersGmInfo)
        {
        }
        ...
        {
            GmActivityMgr.TotemUp += GmActivityMgr_TotemUp;
        }

        private void GmActivityMgr_TotemUp(GamePlayer player, int value)
        {
