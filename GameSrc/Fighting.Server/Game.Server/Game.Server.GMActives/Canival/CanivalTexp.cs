...
{
    public class CanivalTexp : IGMActive
    {
        public CanivalTexp(GmActivityInfo gmActive, List<UserGmActivityInfo> listUsersGmInfo) : base(gmActive, listUsersGmInfo)
        {
        }
        ...
        {
            GmActivityMgr.TexpUp += GmActivityMgr_TexpUp;
        }

        private void GmActivityMgr_TexpUp(GamePlayer player, int value)
        {
