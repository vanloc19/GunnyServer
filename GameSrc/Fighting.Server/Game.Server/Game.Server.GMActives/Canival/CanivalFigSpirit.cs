...
{
    public class CanivalFigSpirit : IGMActive
    {
        public CanivalFigSpirit(GmActivityInfo gmActive, List<UserGmActivityInfo> listUsersGmInfo) : base(gmActive, listUsersGmInfo)
        {
        }
        ...
        {
            GmActivityMgr.FigSpiritUp += GmActivityMgr_FigSpiritUp;
        }

        private void GmActivityMgr_FigSpiritUp(GamePlayer player, int value)
        {
