...
{
    public class KingOfPower : IGMActive
    {
        public KingOfPower(GmActivityInfo gmActive, List<UserGmActivityInfo> listUsersGmInfo) : base(gmActive, listUsersGmInfo)
        {
        }
        ...
        {
            GmActivityMgr.Power += GmActivityMgr_Power;
        }

        private void GmActivityMgr_Power(GamePlayer player, int value)
        {
