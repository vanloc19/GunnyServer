	...
	public class ThirdNormalKingFirst : ABrain
	{
		...
		private bool method_5()
		{
			...
			while (true)
			{
				...
				{
					SimpleNpc simpleNpc = array[num];
					if (simpleNpc.IsLiving && simpleNpc.NpcInfo.ID == ItAwgCwDced)
					{
						break;
					}
					num++;
		...
		{
			((SimpleBoss)base.Body).CreateChild(ItAwgCwDced, 567, 631, 0, 3, 1);
		}
