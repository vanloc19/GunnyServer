...
{
    public class DHTAHBoss2S3 : ABrain
    {
        ...
        private void MoveAndAttack()
        {
            ...
            if (Body.Direction == -1)
                Body.MoveTo(m_targer.X - 100, m_targer.Y, "walk", 1000, AttackRangeRun, 12);
            else
                Body.MoveTo(m_targer.X + 100, m_targer.Y, "walk", 1000, AttackRangeRun, 12);
        }
        ...
        private void NearAttack()
        {
            ...
            if (Body.Direction == -1)
            {
                Body.MoveTo(m_targer.X - 200, m_targer.Y, "walk", 500, AttackRangeRun, 12);
            }
            else
            {
                Body.MoveTo(m_targer.X + 200, m_targer.Y, "walk", 500, AttackRangeRun, 12);
