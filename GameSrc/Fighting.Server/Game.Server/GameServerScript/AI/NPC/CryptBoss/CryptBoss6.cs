...
namespace GameServerScript.AI.NPC
{
	public class CryptBoss6 : ABrain
	{
		...
		private void method_1()
		{
			...
			if (player != null)
			{
				base.Body.MoveTo(player.X + 90, player.Y, "fly", 1000, "", 18, new LivingCallBack(this.method_2));
			}
		}

		private void method_10()
		{
			int num = base.Game.Random.Next(577, 1045);
			int num1 = base.Game.Random.Next(344, 675);
			base.Body.Direction = base.Game.FindlivingbyDir(base.Body);
			base.Body.MoveTo(num, num1, "fly", 1000, "", 18, new LivingCallBack(this.method_11));
		}
		...
		{
			base.Body.RangeAttacking(0, base.Game.Map.Info.ForegroundWidth + 1, "cry", 0, null);
			base.Body.CallFuction(new LivingCallBack(this.method_10), 1500);
		}
		...
		private void method_4()
		{
			...
			if (player != null)
			{
				base.Body.MoveTo(player.X + 99, player.Y, "fly", 1000, "", 18, new LivingCallBack(this.method_5));
			}
		}
		...
		private void method_7()
		{
			...
			if (player != null)
			{
				base.Body.MoveTo(player.X + 112, player.Y, "fly", 1000, "", 18, new LivingCallBack(this.method_8));
			}
		}
		...
		private void method_8()
		{
			...
			base.Body.Direction = base.Game.FindlivingbyDir(base.Body);
			base.Body.PlayMovie("beatC", 3000, 0);
			base.Body.CallFuction(new LivingCallBack(this.method_9), 4500);
		}
