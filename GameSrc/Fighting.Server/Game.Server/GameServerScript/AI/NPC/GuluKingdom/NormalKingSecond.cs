...
namespace GameServerScript.AI.NPC
{
	public class NormalKingSecond : ABrain
	{
		...
		private void method_0()
		{
			...
			((SimpleBoss)base.Body).CurrentDamagePlus = 1000f;
		...
		private void method_4()
		{
			if (int_2 == 0)
			{
				//physicalObj_0 = ((PVEGame)base.Game).CreatePhysicalObj(base.Body.X - 40, 600, "wallLeft", "com.mapobject.asset.WaveAsset_01_left", "1", 1, 0);
				//physicalObj_1 = ((PVEGame)base.Game).CreatePhysicalObj(base.Body.X + 40, 600, "wallLeft", "com.mapobject.asset.WaveAsset_01_right", "1", 1, 0);
				//physicalObj_0.SetRect(-165, -169, 3, 330);
				//physicalObj_1.SetRect(128, 165, 3, 330);
				//int_2 = 1;
				physicalObj_0 = ((PVEGame)Game).CreatePhysicalObj(Body.X - 15, 620, "wallLeft", "com.mapobject.asset.WaveAsset_01_left", "1", 1, 1, 0);
				physicalObj_1 = ((PVEGame)Game).CreatePhysicalObj(Body.X + 15, 620, "wallRight", "com.mapobject.asset.WaveAsset_01_right", "1", 1, 1, 0);
		...
		{
			((SimpleBoss)Body).CreateChild(int_3, BrithPoint, 8, 2, 1);
		}
		...
		private void method_5()
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				if (player != null && !player.IsFrost && base.Body.ShootPoint(player.X, player.Y, 1, 1000, 10000, 1, 2f, 2000))
				{
