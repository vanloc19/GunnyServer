...
namespace GameServerScript.AI.NPC
{
	public class SixTerrorSecondBoss : ABrain
	{
		...
		private List<PhysicalObj> IbrwUhfxWn1;
		...
		private void method_0()
		{
			...
			foreach (SimpleNpc simpleNpc in array)
			{
				...
				{
					IbrwUhfxWn1.Add((base.Game as PVEGame).Createlayer(simpleNpc.X, simpleNpc.Y, "front", "asset.game.six.qunti", "", 1, 0));
				}
			}
		...
		private void method_2()
		{
			...
			foreach (SimpleNpc simpleNpc in array)
			{
				if (!simpleNpc.Config.CompleteStep)
				{
					IbrwUhfxWn1.Add((base.Game as PVEGame).Createlayer(simpleNpc.X, simpleNpc.Y, "front", "asset.game.six.qunjia", "", 1, 0));
				}
			}
		...
		public SixTerrorSecondBoss()
		{
			
			int_0 = 6321;
			int_1 = 6322;
			int_2 = 5000;
			IbrwUhfxWn1 = new List<PhysicalObj>();
