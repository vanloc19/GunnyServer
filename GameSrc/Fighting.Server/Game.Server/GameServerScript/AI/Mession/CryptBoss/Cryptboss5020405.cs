...
{
	public class Cryptboss5020405 : AMissionControl
	{
		...
		public override void OnGameOver()
		{
			...
			{
				allFightPlayer.PlayerDetail.UpdatePveResult("cryotboss", 4, base.Game.IsWin);
			}
		}
