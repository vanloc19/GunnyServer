...
{
	public class DHTAH20302 : AMissionControl
	{
		...
		public override void OnStartGame()
		{
			...
			simpleBoss_1.Say("Mò vào đây ăn trộm à. Chạy ngay đi ...", 0, 300);
		...
		public void CreateStarGame()
		{
			...
			simpleBoss_0.Say(LanguageMgr.GetTranslation("Hồi máu cho anh nào !"), 0, 1500, 0);
		}
		...
		public DHTAH20302()
		{
			...
			int_0 = 20303; // Chiến sĩ bộ lạc
			int_1 = 20304; // dau than
			int_2 = 20305;  // Dũng sĩ bộ lạc
			int_3 = 20306;  // Bulanbala
			int_4 = 5;
		}
	}
}
