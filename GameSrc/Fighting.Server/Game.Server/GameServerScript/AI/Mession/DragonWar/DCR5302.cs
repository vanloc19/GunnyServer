...
namespace GameServerScript.AI.Messions
{
	public class DCR5302 : AMissionControl
	{
		...
		private void method_0()
		{
			...
			simpleBoss_2 = base.Game.CreateBoss(int_3, 1323, 663, -1, 1, "", base.Game.BaseLivingConfig());
			...
			simpleBoss_1 = base.Game.CreateBoss(int_4, 1664, 532, -1, 1, "", base.Game.BaseLivingConfig());
			...
			simpleNpc_1 = base.Game.CreateNpc(int_5, 1360, 840, 1, -1, base.Game.BaseLivingConfig());
			simpleNpc_1.Config.IsTurn = false;
			simpleNpc_1.OnSmallMap(state: false);
			base.Game.SendHideBlood(simpleNpc_1, 0);
			simpleNpc_2 = base.Game.CreateNpc(int_6, 1546, 650, 1, -1, base.Game.BaseLivingConfig());
			simpleNpc_2.Config.IsTurn = false;
			simpleNpc_2.OnSmallMap(state: false);
			base.Game.SendHideBlood(simpleNpc_2, 0);
			simpleNpc_3 = base.Game.CreateNpc(int_2, 503, 831, 1, 1, base.Game.BaseLivingConfig());
		...
		{
			simpleNpc_0 = base.Game.CreateNpc(int_7, 1022, 828, 0, 1, "standB", null);
