...
namespace GameServerScript.AI.Messions
{
	public class DTGAH1165 : AMissionControl
	{
		...
		private PhysicalObj physicalObj_18;

		private PhysicalObj physicalObj_19;
		...
		public override void OnStartGame()
		{
			...
			physicalObj_3 = base.Game.Createlayer(1500, 669, "hide", "asset.game.six.fenshu", "Z", 1, 1);
			physicalObj_3.CanPenetrate = true;
			physicalObj_4 = base.Game.Createlayer(185, 669, "hide", "asset.game.six.shuzi", "z0", 1, 1);
			physicalObj_4.CanPenetrate = true;
			physicalObj_5 = base.Game.Createlayer(240, 669, "hide", "asset.game.six.shuzi", "z0", 1, 1);
			physicalObj_5.CanPenetrate = true;
			physicalObj_6 = base.Game.Createlayer(1575, 669, "hide", "asset.game.six.shuzi", "z0", 1, 1);
			physicalObj_6.CanPenetrate = true;
			physicalObj_7 = base.Game.Createlayer(1630, 669, "hide", "asset.game.six.shuzi", "z0", 1, 1);
			physicalObj_7.CanPenetrate = true;
			LivingConfig livingConfig = base.Game.BaseLivingConfig();
			livingConfig.IsTurn = false;
			livingConfig.CanTakeDamage = false;
			simpleBoss_0 = base.Game.CreateBoss(int_0, 345, 860, -1, 10, "", livingConfig);
		...
		private void method_2()
		{
			...
			physicalObj_8 = base.Game.CreateBall(850, 300, "shield" + num, "s-" + num, 1, 0);
			physicalObj_9 = base.Game.CreateBall(750, 400, "shield" + num2, "s-" + num2, 1, 0);
			physicalObj_10 = base.Game.CreateBall(650, 300, "shield" + num3, "s-" + num3, 1, 0);
			physicalObj_11 = base.Game.CreateBall(950, 400, "shield" + num4, "s-" + num4, 1, 0);
			physicalObj_12 = base.Game.CreateBall(1050, 300, "shield" + num5, "s-" + num5, 1, 0);
			physicalObj_13 = base.Game.CreateBall(1150, 400, "shield" + num6, "s-" + num6, 1, 0);
			physicalObj_14 = base.Game.CreateBall(850, 500, "shield" + num7, "s" + num7, 1, 0);
			physicalObj_15 = base.Game.CreateBall(750, 600, "shield" + num8, "s" + num8, 1, 0);
			physicalObj_16 = base.Game.CreateBall(650, 500, "shield" + num9, "s" + num9, 1, 0);
			physicalObj_17 = base.Game.CreateBall(950, 600, "shield" + num10, "s" + num10, 1, 0);
			physicalObj_18 = base.Game.CreateBall(1050, 500, "shield" + num11, "s" + num11, 1, 0);
			physicalObj_19 = base.Game.CreateBall(1150, 600, "shield" + num12, "s" + num12, 1, 0);
		}
		...
		public override void OnNewTurnStarted()
		{
			...
			base.Game.RemovePhysicalObj(physicalObj_18, true);
			base.Game.RemovePhysicalObj(physicalObj_19, true);
		...
		{
			base.OnBeginNewTurn();
			if (base.Game.TurnIndex > int_1 + 1 && physicalObj_1 != null)
			{
				physicalObj_1.Die();
			...
			physicalObj_4.PlayMovie("z" + text[0].ToString(), 100, 500);
			physicalObj_5.PlayMovie("z" + text[1].ToString(), 100, 500);
			physicalObj_6.PlayMovie("z" + text[0].ToString(), 100, 500);
			physicalObj_7.PlayMovie("z" + text[1].ToString(), 100, 500);
		}
