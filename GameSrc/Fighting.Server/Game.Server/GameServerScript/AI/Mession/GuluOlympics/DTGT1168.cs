		...
		private void method_1()
		{
			if (physicalObj_3 != null && physicalObj_4 != null && physicalObj_5 != null)
			{
				...
				if (list.Count > 0)
				{
					...
					{
						item.AddEffect(new AddBloodTurnEffect(int_7, 1), 0);
					}
				}
				...
				if (list.Count > 0)
				{
					...
					{
						item2.AddEffect(new AddGuardEquipEffect(int_6, 1, isArrmor: false), 0);
					}
				}
				list = new List<Player>();
				...
				if (list.Count > 0)
				{
					...
					{
						item3.AddEffect(new AddDamageTurnEffect(int_5, 1), 0);
					}
				}
			}
		}
