...
namespace GameServerScript.AI.Messions
{
	public class YearMonster : AMissionControl
	{
		...
		public override void OnGameOver()
		{
			...
			{
				allFightPlayer.PlayerDetail.UpdatePveResult("yearmonter", allFightPlayer.TotalDameLiving, base.Game.IsWin);
			}
		}
		...
		{
			base.OnStartGame();
			this.simpleBoss_0 = base.Game.CreateBoss(this.int_0, 1171, 468, -1, 1, "");
