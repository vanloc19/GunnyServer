...
{
	public class FLHS121 : AMissionControl
	{
		...
		public void InitNpcCoor()
		{
			...
			for (int i = 0; i < int_7; i++)
			{
				...
				do
				{
					num2 = base.Game.Random.Next(10, 20);
		...
		public void CreateNpc()
		{
			if (int_0 <= int_7)
			{
				if (bool_1)
				{
					simpleNpc_0 = base.Game.CreateNpc(int_6, 1100, 505, 2);
