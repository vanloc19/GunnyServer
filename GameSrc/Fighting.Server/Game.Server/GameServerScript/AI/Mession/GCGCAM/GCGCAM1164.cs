...
{
    public class GCGCAM1164 : AMissionControl
    {
        ...
        public override void OnStartGame()
        {
			...
			kfxcRiKmuYJ.Say("Chúng mình không muốn bị lây covid. Cứu bé!! Cứu bé!!", 0, 2000);
        ...
        private void method_0()
        {
			...
			simpleBoss_0.Say("Định giải thoát chúng à? Mơ đi bọn đần.", 0, 6000);
			simpleBoss_0.PlayMovie("skill", 8000, 0);
			simpleBoss_0.Say("Giỏi thì phá lá chắn bảo vệ của bố.", 0, 8000);
			...
			simpleBoss_0.Say("Đã đến thì đừng hòng đi. Tao sẽ nhốt hết vào lồng chó.", 0, 14000, 3000);
        }
        ...
        public override void OnDied()
        {
			...
			if (simpleBoss_0 != null && !simpleBoss_0.IsLiving && kfxcRiKmuYJ.IsLiving)
			{
				...
				kfxcRiKmuYJ.Say("Nhanh phá lồng cứu các bố...", 0, waitTimerLeft + 1500, 3500);
