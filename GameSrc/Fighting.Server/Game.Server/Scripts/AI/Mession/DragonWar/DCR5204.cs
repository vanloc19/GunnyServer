...
{
	public class DCR5204 : AMissionControl
	{
		...
		public override void OnStartGame()
		{
			...
			simpleBoss_0 = base.Game.CreateBoss(xoHwalrckqK, 1700, 480, -1, 1, "", livingConfig);
			...
			simpleBoss_0.CallFuction(ayUwadrahlC, 6000);
		...
		private void method_0()
		{
			...
			simpleBoss_1 = base.Game.CreateBoss(int_2, 190, 250, 1, 2, "", livingConfig);
			simpleBoss_1.Delay++;
