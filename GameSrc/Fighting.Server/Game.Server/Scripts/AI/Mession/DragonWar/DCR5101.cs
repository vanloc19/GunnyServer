...
{
	public class DCR5101 : AMissionControl
	{
		private SimpleBoss simpleBoss_0;

		private SimpleNpc simpleNpc_0;

		private SimpleNpc ygmwfmmWvr8;
		...
		private void method_1()
		{
			...
			ygmwfmmWvr8 = base.Game.CreateNpc(int_2, 187, 370, 1, 1, livingConfig);
			base.Game.SendLivingActionMapping(ygmwfmmWvr8, "stand", "standA");
			base.Game.SendObjectFocus(ygmwfmmWvr8, 1, 700, 0);
			ygmwfmmWvr8.PlayMovie("in", 1500, 10000);
			ygmwfmmWvr8.PlayMovie("walkA", 9000, 3000);
		}
		...
		public override void OnShooted()
		{
			...
			if (simpleBoss_0 != null && !simpleBoss_0.IsLiving)
			{
				...
				simpleBoss_0.CallFuction(uhgwffvHlgL, waitTimerLeft + 3000);
			}
		}
