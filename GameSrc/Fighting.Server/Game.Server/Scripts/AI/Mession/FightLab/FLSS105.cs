...
{
	public class FLSS105 : AMissionControl
	{
		...
		public void CreateNpc()
		{
			if (CaUcKiVrdvY <= int_4)
			{
				...
				if (bool_1)
				{
					simpleNpc_0 = base.Game.CreateNpc(int_3, 932, 769, 2, 1, livingConfig);
					bool_1 = false;
				...
				else
				{
					...
					simpleNpc_0 = base.Game.CreateNpc(int_3, point_0[num].X, point_0[num].Y, 2, 1, livingConfig);
					CaUcKiVrdvY++;
					int_2++;
					base.Game.WaitTime(0);
				}
