...
namespace GameServerScript.AI.NPC
{
	public class NormalCaptainAi : ABrain
	{
		...
		private static string[] WqLwpvaMbqe;
		...
		private void method_3()
		{
			...
			base.Body.Say(string_2[num], 1, 3300);
		...
		{
			((SimpleBoss)Body).CreateChild(int_2, brithPoint, 8, 2, 1);
		}

		public NormalCaptainAi()
		{
