        ...
        public void MoveToPlayer(Player player)
        {
            ...
            if (dis > 97)
            {
                ...
                if (player.Y < 420 && player.X < 210)
                {
                    if (Body.Y > 420)
                    {
                        Body.MoveTo(Body.X - dis, Body.Y, "walk", "",((SimpleBoss)Body).NpcInfo.speed, 1200, new LivingCallBack(MoveBeat));
                    }
                    else
                    {
                        if (player.X > Body.X)
                ...
                else
                {
                    if (Body.Y < 420)
                    {
                        ...
                        if (Body.X + dis > 200)
                        {
                            Body.MoveTo(200, Body.Y, "walk", "", ((SimpleBoss)Body).NpcInfo.speed, 1200, new LivingCallBack(Fall));
                        }
                    }
                    else
                    {
