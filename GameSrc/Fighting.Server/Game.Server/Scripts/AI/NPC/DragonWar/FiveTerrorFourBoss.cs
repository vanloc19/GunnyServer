...
namespace GameServerScript.AI.NPC
{
	public class FiveTerrorFourBoss : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				int_1 = base.Body.Blood - base.Body.MaxBlood / 100 * tgxwieJcYvw;
				if (int_1 < 0)
				{
					int_1 = 0;
				}
		...
		{
			base.OnCreated();
			int_1 = base.Body.MaxBlood - base.Body.MaxBlood / 100 * tgxwieJcYvw;
		...
		private void method_4()
		{
			...
			if (m_targer != null)
			{
				...
				base.Body.CallFuction(method_8, 3500);
		...
		private void method_5()
		{
			...
			base.Body.CallFuction(qaywidulCkG, 1500);
		...
		public override void OnAfterTakedBomb()
		{
			if (base.Body.Blood <= int_1 && (int)base.Body.Properties2 == 0 && base.Body.IsLiving)
			{
				...
				method_0();
				base.Body.CallFuction(method_9, 1200);
			}
		}

		public FiveTerrorFourBoss()
		{
			list_0 = new List<PhysicalObj>();
			int_2 = 5334;
			int_3 = 5332;
