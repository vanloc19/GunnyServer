...
namespace GameServerScript.AI.NPC
{
	public class ThirteenNormalNioBoss : ABrain
	{
		...
		private void method_5(List<Player> R7XfMnCQk6xXRo2XOtx)
		{
			base.Body.CurrentDamagePlus = 1000f;
			foreach (Player r7XfMnCQk6xXRo2XOtx in R7XfMnCQk6xXRo2XOtx)
			{
				base.Body.BeatDirect(r7XfMnCQk6xXRo2XOtx, "", 2000, 1, 1);
			}
		}
