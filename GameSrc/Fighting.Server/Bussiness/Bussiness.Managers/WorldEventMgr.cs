...
namespace Bussiness.Managers
{
	public class WorldEventMgr
	{
			...
			using (PlayerBussiness bussiness = new PlayerBussiness())
			{
				...
				for (int i = 0; i < list.Count; i += 5)
				{
					...
					if (list.Count > num3)
					{
						...
						builder.Append("1、" + mail.Annex1Name + "x" + info2.Count + ";");
						builder2.Append("1、" + mail.Annex1Name + "x" + info2.Count + ";");
					}
					num3 = i + 1;
					if (list.Count > num3)
					{
						...
						builder.Append("2、" + mail.Annex2Name + "x" + info2.Count + ";");
						builder2.Append("2、" + mail.Annex2Name + "x" + info2.Count + ";");
					}
					num3 = i + 2;
					if (list.Count > num3)
					{
						...
						builder.Append("3、" + mail.Annex3Name + "x" + info2.Count + ";");
						builder2.Append("3、" + mail.Annex3Name + "x" + info2.Count + ";");
					}
					num3 = i + 3;
					if (list.Count > num3)
					{
						...
						builder.Append("4、" + mail.Annex4Name + "x" + info2.Count + ";");
						builder2.Append("4、" + mail.Annex4Name + "x" + info2.Count + ";");
					}
					num3 = i + 4;
					if (list.Count > num3)
					{
		...
		/*public static bool SendItemsToMails(List<ItemInfo> infos, int PlayerId, string Nickname, int zoneId, string title, string content)
		{
			return SendItemsToMail(infos, PlayerId, Nickname, title);//(infos, PlayerId, Nickname, zoneId, title, 83, null, content);
		}*/
