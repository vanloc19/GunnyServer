			...
			try
			{
				...
				while (resultDataReader.Read())
				{
					PveInfo item = new PveInfo
					{
						...
						FightPower = (resultDataReader["FightPower"] == null) ? "" : resultDataReader["FightPower"].ToString(),
						NightmareGameScript = (resultDataReader["NightmareGameScript"] == null) ? "" : resultDataReader["NightmareGameScript"].ToString(),
						NightmareTemplateIds = (resultDataReader["NightmareTemplateIds"] == null) ? "" : resultDataReader["NightmareTemplateIds"].ToString()
