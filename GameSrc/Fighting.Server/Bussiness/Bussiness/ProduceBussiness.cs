...
namespace Bussiness
{
	public class ProduceBussiness : BaseCrossBussiness
	{
		...
		{
			List<EliteGameAwardInfo> infos = new List<EliteGameAwardInfo>();
			SqlDataReader reader = null;
			try
			{
				db.GetReader(ref reader, "SP_EliteGame_Award_All");
				while (reader.Read())
				{
					infos.Add(InitEliteGameAward(reader));
				}
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
					log.Error("GetAllEliteGameAward", e);
			}
			finally
			{
		...
		{
			EliteGameAwardInfo info = new EliteGameAwardInfo
			{
				ID = (int)reader["ID"],
		...
		{
			List<DailyLeagueAwardItems> list = new List<DailyLeagueAwardItems>();
			SqlDataReader resultDataReader = null;
			try
			{
				db.GetReader(ref resultDataReader, "SP_Get_DailyLeagueAwardItems");
				while (resultDataReader.Read())
				{
					DailyLeagueAwardItems item = new DailyLeagueAwardItems
					{
						ID = (int)resultDataReader["ID"],
			...
			catch (Exception exception)
			{
				if (log.IsErrorEnabled)
				{
					log.Error("GetAllDailyLeagueAwardItems", exception);
				}
			}
			finally
			{
		...
		{
			List<DailyLeagueAwardList> list = new List<DailyLeagueAwardList>();
			SqlDataReader resultDataReader = null;
			try
			{
				db.GetReader(ref resultDataReader, "SP_Get_DailyLeagueAwardList");
				while (resultDataReader.Read())
				{
					DailyLeagueAwardList item = new DailyLeagueAwardList
					{
						Class = (int)resultDataReader["Class"],
			...
			catch (Exception exception)
			{
				if (log.IsErrorEnabled)
				{
					log.Error("GetAllDailyLeagueAwardList", exception);
				}
			}
			finally
			{
			...
			try
			{
				...
				while (resultDataReader.Read())
				{
					FusionInfo item = new FusionInfo
					{
						...
						IsTips = (bool)resultDataReader["IsTips"]
					};
					list.Add(item);
				}
			}
		...
		public MinigameShopTemplateInfo[] GetAllMinigameShop()
		{
			List<MinigameShopTemplateInfo> infos = new List<MinigameShopTemplateInfo>();
			SqlDataReader reader = null;
			try
			{
				db.GetReader(ref reader, "SP_MinigameShop_All");
				while (reader.Read())
				{
					MinigameShopTemplateInfo info = new MinigameShopTemplateInfo();
					info.ID = (int)reader["ID"];
					info.ItemID = (int)reader["ItemID"];
					info.Count = (int)reader["Count"];
					info.IsBind = (bool)reader["IsBind"];
					info.Price = (int)reader["Price"];
					info.LimitCount = (int)reader["LimitCount"];
					info.Type = (int)reader["Type"];
					info.Valid = (int)reader["Valid"];
					infos.Add(info);
				}
			}
			catch (Exception e)
		...
		public StrengThenExpInfo[] GetAllStrengThenExp()
		{
			...
			catch (Exception exception)
			{
				if (log.IsErrorEnabled)
				{
					log.Error("GetStrengThenExpInfo", exception);
				}
			}
			finally
			{
			...
			try
			{
				...
				while (resultDataReader.Read())
				{
					EventAwardInfo item = new EventAwardInfo
					{
						...
						LuckCompose = (int)resultDataReader["LuckCompose"],
						Random = (int)resultDataReader["Random"],
						SelectIndex = (int)resultDataReader["SelectIndex"],
			...
			try
			{
				...
				while (ResultDataReader.Read())
				{
					petTemplateInfoList.Add(new PetTemplateInfo
					{
						...
						LowBloodGrow = (int)ResultDataReader["LowBloodGrow"],
						LowAttackGrow = (int)ResultDataReader["LowAttackGrow"],
						LowDefenceGrow = (int)ResultDataReader["LowDefenceGrow"],
						LowLuckGrow = (int)ResultDataReader["LowLuckGrow"]
					});
				}
			}
			catch (Exception ex)
		...
		public List<Consortia_TaskRewards> GetConSortiaTaskAward(int lv)
		{
			List<Consortia_TaskRewards> list = new List<Consortia_TaskRewards>();
			SqlDataReader ResultDataReader = null;
			try
			{
				SqlParameter[] sqlParameters = new SqlParameter[1]
				...
				db.GetReader(ref ResultDataReader, "SP_Consortia_TaskRewards_All", sqlParameters);
				while (ResultDataReader.Read())
				{
					list.Add(new Consortia_TaskRewards
					{
						ID = (int)ResultDataReader["ID"],
						ItemID = (int)ResultDataReader["ItemID"],
						Lv = (int)ResultDataReader["Lv"],
						Count = (int)ResultDataReader["Count"],
						ValidDate = (int)ResultDataReader["ValidDate"],
						StrengthenLevel = (int)ResultDataReader["StrengthenLevel"],
						AttackCompose = (int)ResultDataReader["AttackCompose"],
			...
			catch (Exception exception)
			{
				if (log.IsErrorEnabled)
				{
					log.Error("SP_Consortia_TaskRewards_Single", exception);
				}
			}
			finally
			{
		...
		public QiYuanAwardInfo[] GetAllQiYuanAward()
		{
			List<QiYuanAwardInfo> list = new List<QiYuanAwardInfo>();
			SqlDataReader sqlDataReader = null;
			try
			{
				db.GetReader(ref sqlDataReader, "SP_QiYuanAward");
				while (sqlDataReader.Read())
				{
					QiYuanAwardInfo item = new QiYuanAwardInfo
					{
						ID = (int)sqlDataReader["ID"],
						Type = (int)sqlDataReader["Type"],
						Rank = (int)sqlDataReader["Rank"],
						TemplateID = (int)sqlDataReader["TemplateID"],
						Count = (int)sqlDataReader["Count"],
						IsBind = (bool)sqlDataReader["IsBind"],
						VaildDate = (int)sqlDataReader["VaildDate"],
		...
		#region GodCardRaise
		public GodCardGroupInfo[] GetAllGodCardGroup()
		{
			List<GodCardGroupInfo> infos = new List<GodCardGroupInfo>();
			SqlDataReader reader = null;
			try
			{
				db.GetReader(ref reader, "SP_God_Card_Group_All");
				while (reader.Read())
				{
					infos.Add(InitGodCardGroup(reader));
				}
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
					log.Error("GetAllGodCardGroup", e);
			}
			finally
			{
				if (reader != null && !reader.IsClosed)
		...
		public GodCardGroupInfo InitGodCardGroup(SqlDataReader reader)
		{
			GodCardGroupInfo info = new GodCardGroupInfo();
			info.GroupID = (int)reader["GroupID"];
			info.GroupName = reader["GroupName"] == null ? "" : reader["GroupName"].ToString();
			info.ExchangeTimes = (int)reader["ExchangeTimes"];
			info.GiftID = (int)reader["GiftID"];
			return info;
		}

		public GodCardGroupDetailInfo[] GetAllGodCardGroupDetail()
		{
			List<GodCardGroupDetailInfo> infos = new List<GodCardGroupDetailInfo>();
			SqlDataReader reader = null;
			try
			{
				db.GetReader(ref reader, "SP_God_Card_Group_Detail_All");
				while (reader.Read())
				{
					infos.Add(InitGodCardGroupDetail(reader));
				}
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
					log.Error("GetAllGodCardGroupDetail", e);
			}
			finally
			{
				if (reader != null && !reader.IsClosed)
		...
		public GodCardGroupDetailInfo InitGodCardGroupDetail(SqlDataReader reader)
		{
			GodCardGroupDetailInfo info = new GodCardGroupDetailInfo();
			info.GroupID = (int)reader["GroupID"];
			info.CardID = (int)reader["CardID"];
			info.Number = (int)reader["Number"];
			return info;
		}

		public GodCardInfo[] GetAllGodCard()
		{
			List<GodCardInfo> infos = new List<GodCardInfo>();
			SqlDataReader reader = null;
			try
			{
				db.GetReader(ref reader, "SP_God_Card_All");
				while (reader.Read())
				{
					infos.Add(InitGodCard(reader));
				}
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
					log.Error("GetAllGodCard", e);
			}
			finally
			{
				if (reader != null && !reader.IsClosed)
		...
		public GodCardInfo InitGodCard(SqlDataReader reader)
		{
			GodCardInfo info = new GodCardInfo();
			info.ID = (int)reader["ID"];
			info.Name = reader["Name"] == null ? "" : reader["Name"].ToString();
			info.Pic = (int)reader["Pic"];
			info.Composition = (int)reader["Composition"];
			info.Decompose = (int)reader["Decompose"];
			info.Level = (int)reader["Level"];
			return info;
		}

		public GodCardPointRewardInfo[] GetAllGodCardPointReward()
		{
			List<GodCardPointRewardInfo> infos = new List<GodCardPointRewardInfo>();
			SqlDataReader reader = null;
			try
			{
				db.GetReader(ref reader, "SP_God_Card_Point_Reward_All");
				while (reader.Read())
				{
					infos.Add(InitGodCardPointReward(reader));
				}
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
					log.Error("GetAllGodCardPointReward", e);
			}
			finally
			{
				if (reader != null && !reader.IsClosed)
		...
		public GodCardPointRewardInfo InitGodCardPointReward(SqlDataReader reader)
		{
			GodCardPointRewardInfo info = new GodCardPointRewardInfo();
			info.ID = (int)reader["ID"];
			info.Count = (int)reader["Count"];
			info.IsBind = (bool)reader["IsBind"];
			info.ItemID = (int)reader["ItemID"];
		...
		public ThreeClearPointAwardInfo[] GetThreeCleanPointAwards()
		{
			List<ThreeClearPointAwardInfo> list = new List<ThreeClearPointAwardInfo>();
			SqlDataReader sqlDataReader = null;
			try
			{
				db.GetReader(ref sqlDataReader, "SP_ThreeClearPointAward_All");
				while (sqlDataReader.Read())
				{
					ThreeClearPointAwardInfo item = new ThreeClearPointAwardInfo
					{
						ID = (int)sqlDataReader["ID"],
		...
		public HappyRechargeData HappyRechargePrize()
		{
			HappyRechargeData HappyRecharge_Prize = null;
			SqlDataReader ResultDataReader2 = (SqlDataReader)null;
			try
			{
				this.db.GetReader(ref ResultDataReader2, "SP_Get_HappyRecharge_Prize");
				while (ResultDataReader2.Read())
				{
					HappyRecharge_Prize = new HappyRechargeData()
					{
						TemplateID = (int)ResultDataReader2["TemplateID"],
						Count = (int)ResultDataReader2["Count"],
						ValiDate = (int)ResultDataReader2["ValiDate"]
					};
				}
			}
			catch (Exception ex)
			{
				if (log.IsErrorEnabled)
					log.Error("HappyRechargePrize", ex);
			}
			finally
			{
				if ((ResultDataReader2 == null ? 0 : (!ResultDataReader2.IsClosed ? 1 : 0)) != 0)
					ResultDataReader2.Close();
			}
			return HappyRecharge_Prize;
		}

		public HappyRechargeDataPrize[] GetHappyRechargeData()
		{
			List<HappyRechargeDataPrize> list = new List<HappyRechargeDataPrize>();
			SqlDataReader ResultDataReader2 = (SqlDataReader)null;
			try
			{
				this.db.GetReader(ref ResultDataReader2, "SP_Get_HappyRecharge_Data");
				while (ResultDataReader2.Read())
				{
					HappyRechargeDataPrize HappyRecharge_DataPrize = new HappyRechargeDataPrize()
					{
						PrizeType = (int)ResultDataReader2["PrizeType"],
						Count = (int)ResultDataReader2["Count"],
						NickName = (string)ResultDataReader2["NickName"]
					};
					list.Add(HappyRecharge_DataPrize);
				}
			}
			catch (Exception ex)
			{
				if (log.IsErrorEnabled)
					log.Error("GetHappyRechargeData", ex);
			}
			finally
			{
				if ((ResultDataReader2 == null ? 0 : (!ResultDataReader2.IsClosed ? 1 : 0)) != 0)
		...
		public List<HappyRechargeTicketReward> GetRewardHappyTicket()
		{
			List<HappyRechargeTicketReward> list = new List<HappyRechargeTicketReward>();
			SqlDataReader ResultDataReader2 = (SqlDataReader)null;
			try
			{
				this.db.GetReader(ref ResultDataReader2, "SP_Get_HappyRecharge_TicketReward");
				while (ResultDataReader2.Read())
				{
					HappyRechargeTicketReward HappyRecharge_TicketReward = new HappyRechargeTicketReward()
					{
						TemplateID = (int)ResultDataReader2["TemplateID"],
						Count = (int)ResultDataReader2["Count"],
						ValiDate = (int)ResultDataReader2["ValiDate"],
						TicketPrice = (string)ResultDataReader2["ticketPrice"]
					};
					list.Add(HappyRecharge_TicketReward);
				}
			}
			catch (Exception ex)
			{
				if (log.IsErrorEnabled)
					log.Error("GetRewardHappyTicket", ex);
			}
			finally
			{
				if ((ResultDataReader2 == null ? 0 : (!ResultDataReader2.IsClosed ? 1 : 0)) != 0)
		...
		public List<HappyRechargeReward> HappyRechargeReward()
		{
			List<HappyRechargeReward> list = new List<HappyRechargeReward>();
			SqlDataReader ResultDataReader2 = (SqlDataReader)null;
			try
			{
				this.db.GetReader(ref ResultDataReader2, "SP_Get_HappyRecharge_Rewards");
				while (ResultDataReader2.Read())
				{
					HappyRechargeReward integralShopInfo = new HappyRechargeReward()
					{
						ID = (int)ResultDataReader2["ID"],
						TemplateID = (int)ResultDataReader2["TemplateID"],
						Count = (int)ResultDataReader2["Count"],
						ValiDate = (int)ResultDataReader2["ValiDate"],
						isBind = (bool)ResultDataReader2["isBind"]
					};
					list.Add(integralShopInfo);
				}
			}
			catch (Exception ex)
			{
				if (log.IsErrorEnabled)
					log.Error("HappyRechargeReward", ex);
			}
			finally
			{
				if ((ResultDataReader2 == null ? 0 : (!ResultDataReader2.IsClosed ? 1 : 0)) != 0)
		...
		public bool UpdateHappyRechargeDataPrize(int prizeType, int count, string NickName)
		{
			bool result = false;
			try
			{
				SqlParameter[] array = new SqlParameter[3];
				array[0] = new SqlParameter("@PrizeType", (int)prizeType);
				array[1] = new SqlParameter("@Count", (int)count);
				array[2] = new SqlParameter("@NickName", (string)NickName);
				result = this.db.RunProcedure("SP_Update_HappyRecharge_Data", array);
			}
			catch (Exception ex)
			{
				if (log.IsErrorEnabled)
					log.Error("HappyRechargeDataUpdate", ex);
			}
			return result;
		}

		public bool UpdateHappyRechargePrize(int count)
		{
			bool result = false;
			try
			{
				...
				{
					new SqlParameter("@Count", (int)count),
				};
				result = this.db.RunProcedure("SP_Update_HappyRecharge_Prize", array);
			}
			catch (Exception ex)
			{
				if (log.IsErrorEnabled)
					log.Error("HappyRechargePfizeUpdate", ex);
			}
			return result;
		}
		...
		public TotemInfo[] GetAllTotem()
		{
			...
			try
			{
				...
				while (reader.Read())
				{
					...
					info.Point = (int)reader["Point"];
					info.DiscountMoney = (int)reader["DiscountMoney"];
					infos.Add(info);
				}
			}
			catch (Exception e)
		...
		public FightSpiritTemplateInfo[] GetAllFightSpiritTemplate()
		{
			...
			try
			{
				db.GetReader(ref reader, "SP_FightSpiritTemplate_All");
				while (reader.Read())
				{
					FightSpiritTemplateInfo info = new FightSpiritTemplateInfo();
					info.FightSpiritID = (int)reader["FightSpiritID"];
					info.FightSpiritIcon = (string)reader["FightSpiritIcon"];
					info.Level = (int)reader["Level"];
		...
		{
			List<LoveLevelInfo> infos = new List<LoveLevelInfo>();
			SqlDataReader reader = null;
			try
			{
				db.GetReader(ref reader, "SP_Love_level_All");
				while (reader.Read())
				{
					infos.Add(InitLoveLevel(reader));
				}
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
					log.Error("GetAllLoveLevel", e);
			}
			finally
			{
				if (reader != null && !reader.IsClosed)
		...
		public LoveLevelInfo InitLoveLevel(SqlDataReader reader)
		{
			LoveLevelInfo info = new LoveLevelInfo();
			info.Level = (int)reader["Level"];
			info.Exp = (int)reader["Exp"];
			info.Animation = (int)reader["Animation"];
			info.SkillID = (int)reader["SkillID"];
			info.Attack = (int)reader["Attack"];
			info.Defence = (int)reader["Defence"];
			info.Agility = (int)reader["Agility"];
		...
		public SetsBuildTempInfo[] GetAllSetsBuildTemp()
		{
			...
			try
			{
				db.GetReader(ref reader, "SP_Sets_Build_Temp_All");
				while (reader.Read())
				{
					infos.Add(InitSetsBuildTemp(reader));
				}
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
					log.Error("GetAllSetsBuildTemp", e);
			}
			finally
			{
				if (reader != null && !reader.IsClosed)
		...
		{
			SetsBuildTempInfo info = new SetsBuildTempInfo();
			info.Level = (int)reader["Level"];
			info.SetsType = (int)reader["SetsType"];
			info.UseItemTemplate = (int)reader["UseItemTemplate"];
			info.Exp = (int)reader["Exp"];
			...
			info.MagicDefenceGrow = (int)reader["MagicDefenceGrow"];
			info.GuardGrow = (int)reader["GuardGrow"];
			return info;
		}

		public WorldBossTopTenAwardInfo[] GetAllWorldbossTopTenAward()
		{
			List<WorldBossTopTenAwardInfo> list = new List<WorldBossTopTenAwardInfo>();
			SqlDataReader sqlDataReader = null;
			try
			{
				this.db.GetReader(ref sqlDataReader, "SP_WorldbossTopTenAward_All");
				while (sqlDataReader.Read())
				{
					WorldBossTopTenAwardInfo item = new WorldBossTopTenAwardInfo
					{
						ID = (int)sqlDataReader["ID"],
						Type = (int)sqlDataReader["Type"],
						TemplateID = (int)sqlDataReader["TemplateID"],
						...
						IsBinds = (bool)sqlDataReader["IsBind"]
					};
					list.Add(item);
				}
			}
			catch (Exception exception)
			{
				if (log.IsErrorEnabled)
				{
					log.Error("GetWorldBoss_Topten_Award_All", exception);
				}
			}
			finally
			{
		...
		public ClothPropertyTemplateInfo[] GetAllClothPropertyTemplateInfos()
		{
			...
			try
			{
				db.GetReader(ref reader, "SP_ClothPropertyTemplate_All");
				while (reader.Read())
				{
					ClothPropertyTemplateInfo info = new ClothPropertyTemplateInfo();
					info.ID = (int)reader["ID"];
					info.Sex = (int)reader["Sex"];
					info.Name = reader["Name"] == null ? "" : reader["Name"].ToString();
					info.Attack = (int)reader["Attack"];
					info.Defend = (int)reader["Defend"];
					info.Agility = (int)reader["Agility"];
					info.Luck = (int)reader["Luck"];
					info.Blood = (int)reader["Blood"];
					info.Damage = (int)reader["Damage"];
					info.Guard = (int)reader["Guard"];
					info.Cost = (int)reader["Cost"];
					info.Type = (int)reader["Type"];
					infos.Add(info);
				}
			}
			...
			{
				if (log.IsErrorEnabled)
					log.Error("GetAllClothPropertyTemplateInfos", e);
			}
			finally
			{
				if (reader != null && !reader.IsClosed)
		...
		public ClothGroupTemplateInfo[] GetAllClothGroupTemplateInfos()
		{
			...
			try
			{
				db.GetReader(ref reader, "SP_ClothGroupTemplate_All");
				while (reader.Read())
				{
					ClothGroupTemplateInfo info = new ClothGroupTemplateInfo();
					info.ID = (int)reader["ID"];
					info.TemplateID = (int)reader["TemplateID"];
					info.Sex = (int)reader["Sex"];
					info.Description = (int)reader["Description"];
					info.Cost = (int)reader["Cost"];
					info.Type = (int)reader["Type"];
					//info.Type = (int)reader["Type"];
					info.OtherTemplateID = reader["OtherTemplateID"] == null ? "" : reader["OtherTemplateID"].ToString();
					infos.Add(info);
				}
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
					log.Error("GetAllClothGroupTemplateInfos", e);
			}
			finally
			{
				if (reader != null && !reader.IsClosed)
		...
		public ActivitySystemItemInfo[] GetAllActivitySystemItem()
		{
			...
			try
			{
				...
				while (reader.Read())
				{
					...
					info.canRenew = (bool)reader["canRenew"];
					info.canTransfer = (bool)reader["canTransfer"];
					infos.Add(info);
				}
			}
			catch (Exception e)
		...
		public DailyLeagueLevelInfo[] GetAllDailyLeagueLevelInfo()
		{
			...
			try
			{
				db.GetReader(ref read, "SP_DailyLeagueLevelInfo_All");
				while (read.Read())
				{
					DailyLeagueLevelInfo info = new DailyLeagueLevelInfo();
					info.Name = read["Name"].ToString();
					info.Level = (int)read["Level"];
					info.Score = (int)read["Score"];
					list.Add(info);
				}
			}
			catch (Exception ex)
			{
				if (log.IsErrorEnabled)
				{
					log.Error("GetAllDailyLeagueLevelInfo", ex);
				}
			}
			finally
			{
		...
		public DailyLeagueAwardInfo[] GetAllDailyLeagueAwardInfo()
		{
			...
			try
			{
				db.GetReader(ref read, "SP_DailyLeagueAwardInfo_All");
				while (read.Read())
				{
					DailyLeagueAwardInfo info = new DailyLeagueAwardInfo();
					info.Level = (int)read["Level"];
					info.Class = (int)read["Class"];
					info.Count = (int)read["Count"];
					info.TemplateID = (int)read["TemplateID"];
					info.RewardID = (int)read["RewardID"];
					info.StrengthenLevel = (int)read["StrengthenLevel"];
					info.ItemValid = (int)read["ItemValid"];
					info.IsBind = (bool)read["IsBind"];
					info.AgilityCompose = (int)read["AgilityCompose"];
					info.AttackCompose = (int)read["AttackCompose"];
					info.DefendCompose = (int)read["DefendCompose"];
					info.LuckCompose = (int)read["LuckCompose"];
					info.Hole1 = (int)read["Hole1"];
					info.Hole2 = (int)read["Hole2"];
					info.Hole3 = (int)read["Hole3"];
					info.Hole4 = (int)read["Hole4"];
					info.Hole5 = (int)read["Hole5"];
					info.Hole5Exp = (int)read["Hole5Exp"];
					info.Hole5Level = (int)read["Hole5Level"];
					info.Hole6 = (int)read["Hole6"];
					info.Hole6Exp = (int)read["Hole6Exp"];
					info.Hole6Level = (int)read["Hole6Level"];
					list.Add(info);
				}
			}
			catch (Exception ex)
			{
				if (log.IsErrorEnabled)
				{
					log.Error("GetAllDailyLeagueAwardInfo", ex);
				}
			}
			finally
			{
		...
		#endregion
		#region ExplorerManual
		public JampsUpgradeItemList[] Get_JampsUpgradeItemList()
		{
			List<JampsUpgradeItemList> list = new List<JampsUpgradeItemList>();
			SqlDataReader sqlDataReader = null;
			try
			{
				this.db.GetReader(ref sqlDataReader, "SP_JampsUpgradeItemList");
				while (sqlDataReader.Read())
				{
					JampsUpgradeItemList o = new JampsUpgradeItemList();
					for (int x = 0; x < sqlDataReader.FieldCount; x++)
					{
						if (o.GetType().GetField(sqlDataReader.GetName(x)) == null)
						{
							log.Info("Campo " + sqlDataReader.GetName(x) + " Faltando em " + o.GetType());
							continue;
						}

						o.GetType().GetField(sqlDataReader.GetName(x)).SetValue(o, sqlDataReader[x]);
					}
		...
		public JampsUpgradeItemList[] Get_JampsUpgradeItemList(int level)
		{
			List<JampsUpgradeItemList> list = new List<JampsUpgradeItemList>();
			SqlDataReader sqlDataReader = null;
			try
			{
				...
				paramenter[0] = new SqlParameter("@Level", level);
				this.db.GetReader(ref sqlDataReader, "SP_JampsUpgradeItemList", paramenter);
				while (sqlDataReader.Read())
				{
					JampsUpgradeItemList o = new JampsUpgradeItemList();
					for (int x = 0; x < sqlDataReader.FieldCount; x++)
        ...
        public JampsDebrisItemList[] Get_JampsDebrisItemList()
		{
			...
			try
			{
				this.db.GetReader(ref sqlDataReader, "SP_JampsDebrisItemList");
				while (sqlDataReader.Read())
				{
					JampsDebrisItemList o = new JampsDebrisItemList();
					for (int x = 0; x < sqlDataReader.FieldCount; x++)
					{
						if (o.GetType().GetField(sqlDataReader.GetName(x)) == null)
						{
