...
namespace Game.Logic.Actions
{
	public class LivingShootAction : BaseAction
	{
		...
		protected override void ExecuteImp(BaseGame game, long tick)
		{
			...
			if (m_living.ShootImp(m_bombId, m_tx, m_ty, m_force, m_angle, m_bombCount, 0) && livingCallBack_0 != null)
			{
				m_living.CallFuction(livingCallBack_0, m_living.LastLifeTimeShoot);
			}
			Finish(tick);
		}
	}
