...
namespace Game.Logic.Actions
{
    public class BotShootAction : BaseAction
    {
        ...
        public BotShootAction(Player living, int x, int y, int force, int angle, int bombCount, int minTime,
            int maxTime, float time, int delay)
            : base(delay, 1000)
        {
            m_player = living;
        ...
        {
            m_player.GetShootForceAndAngle(ref m_tx, ref m_ty, m_bombId, m_minTime, m_maxTime, m_bombCount, m_Time,
                ref m_force, ref m_angle);
