...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1231 : BasePetEffect
    {
        ...
        {
            AE1231 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1231) as AE1231;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(new CE1231(0, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}