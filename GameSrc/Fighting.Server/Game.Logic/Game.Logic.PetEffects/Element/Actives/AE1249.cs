...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1249 : BasePetEffect
    {
        ...
        {
            AE1249 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1249) as AE1249;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1249(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}