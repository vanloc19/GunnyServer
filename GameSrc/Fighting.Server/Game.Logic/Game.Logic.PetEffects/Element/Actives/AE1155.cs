...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1155 : BasePetEffect
    {
        ...
        {
            AE1155 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1155) as AE1155;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1155(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
