...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1043 : BasePetEffect
    {
        ...
        {
            AE1043 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1043) as AE1043;
            if (effect != null)
            {
        ...
        private void Player_PlayerBuffSkillPet(Player player)
        {
            if (player.PetEffects.CurrentUseSkill == m_currentId)
            {
                ...
                player.AddPetEffect(
                    new CE1043(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
