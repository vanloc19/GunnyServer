...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1195 : BasePetEffect
    {
        ...
        {
            AE1195 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1195) as AE1195;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1195(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
