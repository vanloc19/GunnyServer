...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1194 : BasePetEffect
    {
        ...
        {
            AE1194 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1194) as AE1194;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1194(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}