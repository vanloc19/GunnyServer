...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1186 : BasePetEffect
    {
        ...
        {
            AE1186 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1186) as AE1186;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1186(0, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}