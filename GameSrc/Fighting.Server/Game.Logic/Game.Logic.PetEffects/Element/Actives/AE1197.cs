...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1197 : BasePetEffect
    {
        ...
        {
            AE1197 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1197) as AE1197;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1197(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
