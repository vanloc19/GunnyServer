...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1187 : BasePetEffect
    {
        ...
        {
            AE1187 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1187) as AE1187;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1187(0, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}