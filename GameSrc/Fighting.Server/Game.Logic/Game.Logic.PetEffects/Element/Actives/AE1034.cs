...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1034 : BasePetEffect
    {
        ...
        {
            AE1034 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1034) as AE1034;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            if (player.PetEffects.CurrentUseSkill == m_currentId)
            {
                ...
                player.AddPetEffect(new CE1034(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}