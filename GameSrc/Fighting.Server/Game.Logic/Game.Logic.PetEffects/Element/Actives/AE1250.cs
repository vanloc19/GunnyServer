...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1250 : BasePetEffect
    {
        ...
        {
            AE1250 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1250) as AE1250;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1250(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
