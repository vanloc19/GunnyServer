...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1046 : BasePetEffect
    {
        ...
        {
            AE1046 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1046) as AE1046;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            if (player.PetEffects.CurrentUseSkill == m_currentId)
            {
                ...
                player.AddPetEffect(new CE1046(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}