...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1116 : BasePetEffect
    {
        ...
        {
            AE1116 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1116) as AE1116;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(new CE1116(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}