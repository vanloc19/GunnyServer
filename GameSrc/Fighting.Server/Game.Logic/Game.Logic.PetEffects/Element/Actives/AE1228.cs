...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1228 : BasePetEffect
    {
        ...
        {
            AE1228 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1228) as AE1228;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1228(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
    }
}