...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1174 : BasePetEffect
    {
        ...
        {
            AE1174 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1174) as AE1174;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(
                    new CE1174(3, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
