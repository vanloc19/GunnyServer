...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1044 : BasePetEffect
    {
        ...
        {
            AE1044 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1044) as AE1044;
            if (effect != null)
            {
        ...
        private void Player_PlayerBuffSkillPet(Player player)
        {
            if (player.PetEffects.CurrentUseSkill == m_currentId)
            {
                ...
                player.AddPetEffect(
                    new CE1044(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
            }
        }
