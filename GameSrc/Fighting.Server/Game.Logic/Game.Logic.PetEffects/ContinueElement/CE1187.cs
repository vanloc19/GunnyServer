...
namespace Game.Logic.PetEffects.ContinueElement
{
    public class CE1187 : BasePetEffect
    {
        ...
        {
            CE1187 effect = living.PetEffectList.GetOfType(ePetEffectType.CE1187) as CE1187;
            if (effect != null)
            {
        ...
        private void Player_BeginSelfTurn(Living living)
        {
            ...
            if (living.Blood <= 0)
            {
                ...
                if (living.Game.CurrentLiving != null && living.Game.CurrentLiving is Player)
                    (living.Game.CurrentLiving as Player).PlayerDetail.OnKillingLiving(living.Game, 2, living.Id,
                        living.IsLiving, m_added);
            }
        }
