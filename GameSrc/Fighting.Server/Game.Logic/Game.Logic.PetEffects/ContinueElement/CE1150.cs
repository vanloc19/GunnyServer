...
namespace Game.Logic.PetEffects.ContinueElement
{
    public class CE1150 : BasePetEffect
    {
        ...
        {
            CE1150 effect = living.PetEffectList.GetOfType(ePetEffectType.CE1150) as CE1150;
            if (effect != null)
            {
            ...
            else
            {
                ...
                if (living.Blood <= 0)
                {
                    ...
                    if (m_source != null && m_source is Player)
                        (m_source as Player).PlayerDetail.OnKillingLiving(m_source.Game, 2, living.Id, living.IsLiving,
                            m_added);
                }
            }
        }
