namespace Game.Logic
{
	...
	private int m_AttackPercent;
	private int m_DefencePercent;
	private int m_AgilityPercent;
	private int m_MagicAttackPercent;
	private int m_MagicDefencePercent;
	...
	public bool ActiveEffect;
		...
		public bool DisibleActiveSkill
        {
			get
            {
				return m_DisibleActiveSkill;
            }
			set
            {
				m_DisibleActiveSkill = value;
            }
        }
	...
	public int DefencePercent
    {
		get
        {
			return m_DefencePercent;
        }
		set
        {
			m_DefencePercent = value;
        }
    }
	...
	public int AgilityPercent
    {
		get
        {
			return m_AgilityPercent;
        }
		set
        {
			m_AgilityPercent = value;
        }
    }
	...
	public int MagicAttackPercent
    {
		get
        {
			return m_MagicAttackPercent;
        }
		set
        {
			m_MagicAttackPercent = value;
        }
    }

	public int MagicDefencePercent
    {
		get
        {
			return m_MagicDefencePercent;
        }
		set
        {
			m_MagicDefencePercent = value;
        }
    }
