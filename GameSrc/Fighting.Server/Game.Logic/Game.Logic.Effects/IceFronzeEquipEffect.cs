...
namespace Game.Logic.Effects
{
    public class IceFronzeEquipEffect : BasePlayerEffect
    {
        ...
        {
            IceFronzeEquipEffect effect =
                living.EffectList.GetOfType(eEffectType.IceFronzeEquipEffect) as IceFronzeEquipEffect;
            if (effect != null)
            {
        ...
        private void ChangeProperty(Player player)
        {
            ...
            if (rand.Next(100) < m_probability && player.AttackGemLimit == 0)
            {
                ...
                SpellMgr.ExecuteSpell(player.Game, player, ItemMgr.FindItemTemplate((int)BuffType.IceFronze));
