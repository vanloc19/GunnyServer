...
{
    public class ReduceDamageEffect : BasePlayerEffect //ºı…Ÿ…À∫¶
    {
        ...
        {
            ReduceDamageEffect effect =
                living.EffectList.GetOfType(eEffectType.ReduceDamageEffect) as ReduceDamageEffect;
            if (effect != null)
            {
