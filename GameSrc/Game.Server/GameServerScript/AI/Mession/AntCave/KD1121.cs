...
namespace GameServerScript.AI.Messions
{
	public class KD1121 : AMissionControl
	{
		...
		private PhysicalObj TewcsdgMngT;
		...
		{
			base.OnStartGame();
			TewcsdgMngT = base.Game.Createlayer(0, 0, "moive", "game.asset.living.BossBgAsset", "out", 1, 1);
			physicalObj_0 = base.Game.Createlayer(1131, 150, "font", "game.asset.living.AntQueenAsset", "out", 1, 1);
			simpleBoss_0 = base.Game.CreateBoss(int_1, 1316, 444, -1, 1, "");
			simpleBoss_0.SetRelateDemagemRect(-42, -200, 84, 194);
			simpleBoss_0.Say(LanguageMgr.GetTranslation("Hộp là của tôi, con tôi, miễn là tôi có thể thấy là của tôi!"), 0, 200, 0);
			TewcsdgMngT.PlayMovie("in", 6000, 0);
			physicalObj_0.PlayMovie("in", 6100, 0);
			TewcsdgMngT.PlayMovie("out", 10000, 1000);
			physicalObj_0.PlayMovie("out", 9900, 0);
		}
		...
		public override void OnBeginNewTurn()
		{
			...
			if (base.Game.TurnIndex > 1)
			{
				if (TewcsdgMngT != null)
				{
					base.Game.RemovePhysicalObj(TewcsdgMngT, sendToClient: true);
					TewcsdgMngT = null;
				}
