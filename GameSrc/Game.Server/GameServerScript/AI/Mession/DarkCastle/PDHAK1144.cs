...
namespace GameServerScript.AI.Messions
{
	public class PDHAK1144 : AMissionControl
	{
		...
		public override void OnStartGame()
		{
			...
			simpleBoss_0 = base.Game.CreateBoss(wlgcNdbaAtH, 1255, 958, -1, 3, "born", livingConfig);
		...
		public override bool CanGameOver()
		{
			...
			{
				int_0++;
				simpleBoss_1 = base.Game.CreateBoss(int_1, simpleBoss_0.X, simpleBoss_0.Y, simpleBoss_0.Direction, 1, "standB");
