...
{
    public class GAAM3 : AMissionControl
    {
        ...
        public override void OnPrepareNewGame()
        {
            ...
            for (int i = 0; i < Game.TotalCount; i++)
            {
                ...
                else
                {
                    ...
                    m_key.Add(Game.CreatePhysicalObj(m_bord.ToArray()[index].X, m_bord.ToArray()[index].Y - 8, keyIndex, "game.crazytank.assetmap.Key", "1", 1, 0, 0));
        ...
        public override void OnGameOver()
        {
            ...
            List<LoadingFileInfo> loadingFileInfos = new List<LoadingFileInfo>();
            loadingFileInfos.Add(new LoadingFileInfo(2, "image/map/1/show5.jpg", ""));
            Game.SendLoadResource(loadingFileInfos);
        }
    }
}
