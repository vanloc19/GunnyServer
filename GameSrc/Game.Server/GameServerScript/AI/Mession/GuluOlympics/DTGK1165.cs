...
namespace GameServerScript.AI.Messions
{
	public class DTGK1165 : AMissionControl
	{
		...
		private PhysicalObj zBqwConTyGr;
		...
		private PhysicalObj alKwCaKgSwp;
		...
		private void method_2()
		{
			...
			zBqwConTyGr = base.Game.CreateBall(750, 400, "shield" + num2, "s-" + num2, 1, 0);
			physicalObj_9 = base.Game.CreateBall(650, 300, "shield" + num3, "s-" + num3, 1, 0);
			physicalObj_10 = base.Game.CreateBall(950, 400, "shield" + num4, "s-" + num4, 1, 0);
			physicalObj_11 = base.Game.CreateBall(1050, 300, "shield" + num5, "s-" + num5, 1, 0);
			physicalObj_12 = base.Game.CreateBall(1150, 400, "shield" + num6, "s-" + num6, 1, 0);
			physicalObj_13 = base.Game.CreateBall(850, 500, "shield" + num7, "s" + num7, 1, 0);
			physicalObj_14 = base.Game.CreateBall(750, 600, "shield" + num8, "s" + num8, 1, 0);
			physicalObj_15 = base.Game.CreateBall(650, 500, "shield" + num9, "s" + num9, 1, 0);
			physicalObj_16 = base.Game.CreateBall(950, 600, "shield" + num10, "s" + num10, 1, 0);
			alKwCaKgSwp = base.Game.CreateBall(1050, 500, "shield" + num11, "s" + num11, 1, 0);
		...
		public override void OnNewTurnStarted()
		{
			...
			base.Game.RemovePhysicalObj(zBqwConTyGr, true);
			...
			base.Game.RemovePhysicalObj(alKwCaKgSwp, true);
