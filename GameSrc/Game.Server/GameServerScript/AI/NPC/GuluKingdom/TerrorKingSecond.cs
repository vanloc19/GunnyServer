...
namespace GameServerScript.AI.NPC
{
	public class TerrorKingSecond : ABrain
	{
		...
		private void method_0()
		{
			...
			if (list.Count != allFightPlayers.Count)
			{
				if (list.Count != 0)
				{
					...
					base.Body.RangeAttacking(base.Body.X - 10000, base.Body.X + 10000, "beat1", 1500, list);
				}
				else
				{
					base.Body.PlayMovie("beat1", 0, 0);
					base.Body.RangeAttacking(base.Body.X - 10000, base.Body.X + 10000, "beat1", 1500, null);
				}
			}
			else
			{
		...
		private void method_4()
		{
			if (int_2 == 0)
			{
				//physicalObj_0 = ((PVEGame)base.Game).CreatePhysicalObj(base.Body.X - 65, 600, "wallLeft", "com.mapobject.asset.WaveAsset_01_left", "1", 1, 0);
				//physicalObj_1 = ((PVEGame)base.Game).CreatePhysicalObj(base.Body.X + 65, 600, "wallLeft", "com.mapobject.asset.WaveAsset_01_right", "1", 1, 0);
