...
namespace GameServerScript.AI.NPC
{
	public class HardKingFirst : ABrain
	{
		...
		private void method_0(int int_1, int int_2)
		{
			...
			base.Body.Say(string_4[num], 1, 1000);
		...
		private void method_4()
		{
			...
			if (player != null)
			{
				...
				if (base.Body.ShootPoint(x, player.Y, 61, 1000, 10000, 1, 3f, 2300))
				{
					base.Body.PlayMovie("beat2", 1500, 0);
				}
				if (base.Body.ShootPoint(x, player.Y, 61, 1000, 10000, 1, 3f, 4100))
				{
					base.Body.PlayMovie("beat2", 3300, 0);
				}
				if (base.Body.ShootPoint(x, player.Y, 61, 1000, 10000, 1, 3f, 5900))
				{
		...
		public HardKingFirst()
		{
			
			
		}

		static HardKingFirst()
		{
