...
namespace GameServerScript.AI.NPC
{
	public class ThirteenSimpleBrynBoss : ABrain
	{
		...
		private void EnEsOlysLyn()
		{
			...
			base.Body.CallFuction(new LivingCallBack(this.method_5), 2800);
		}
		...
		private void method_7()
		{
			...
			base.Body.CallFuction(new LivingCallBack(this.method_8), 1200);
		}
