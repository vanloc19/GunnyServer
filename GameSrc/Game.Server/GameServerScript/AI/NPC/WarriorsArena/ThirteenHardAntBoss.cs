...
{
	public class ThirteenHardAntBoss : ABrain
	{
		private int int_0;
		...
		private string[] xoYsxiyXcgd;

		private string[] string_0;

		public ThirteenHardAntBoss()
		{
			
			this.list_0 = new List<PhysicalObj>();
			this.int_1 = 13202;
			this.xoYsxiyXcgd = new string[] { "Hãy liếm thử mũi tên này của ta", "Xem có thốn không nhé", "Ta sẽ hạ sát hết lũ các ngươi", "Các ngươi nghĩ đủ trình hạ ta?." };
			this.string_0 = new string[] { "Băng trâm tiễn.", "Liếm thử băng trâm tiễn của ta", "Để ta giúp ngươi về trời nhanh." };
		...
		private void method_1()
		{
			...
			base.Body.Say(this.string_0[num], 0, 1000, 0);
		...
		private void method_2()
		{
			...
			int num = base.Game.Random.Next(0, (int)this.xoYsxiyXcgd.Length);
			base.Body.Say(this.xoYsxiyXcgd[num], 0, 1000, 6000);
		...
		private void method_4(List<Player> roxRJ2VSi5MwnkiSrp9)
		{
			base.Body.CurrentDamagePlus = 1000f;
			base.Body.PlayMovie("beatB", 1000, 0);
			foreach (Player player in roxRJ2VSi5MwnkiSrp9)
			{
