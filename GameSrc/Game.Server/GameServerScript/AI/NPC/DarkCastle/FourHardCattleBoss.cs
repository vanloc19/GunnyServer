...
namespace GameServerScript.AI.NPC
{
	public class FourHardCattleBoss : ABrain
	{
			...
			if (int_0 == 0)
			{
				if (!bool_0)
				{
					...
					if (((SimpleBoss)base.Body).CurrentLivingNpcNum <= 0)
					{
						...
						base.Body.CallFuction(method_9, 7000);
					}
					else
					{
		...
		private void method_0(int int_5, int int_6)
		{
			...
			base.Body.CallFuction(method_11, 8000);
		}
		...
		private void method_1()
		{
			...
			if (player_0 != null)
			{
				...
				base.Body.CallFuction(method_11, 6000);
			}
		}
		...
		private void method_2()
		{
			...
			{
				allLivingPlayer.AddEffect(new ReduceStrengthEffect(1, int_3), 4200);
			}
		...
		private void method_3()
		{
			...
			base.Body.CallFuction(method_11, 7000);
		}
		...
		private void method_9()
		{
			...
			for (int i = 0; i < int_1; i++)
			{
				...
				((SimpleBoss)base.Body).CreateChild(int_2, x, y, showBlood: true, livingConfig);
			}
		}
