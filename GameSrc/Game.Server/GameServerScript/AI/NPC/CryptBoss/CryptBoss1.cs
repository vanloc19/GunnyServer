...
namespace GameServerScript.AI.NPC
{
	public class CryptBoss1 : ABrain
	{
		...
		private void method_0()
		{
			...
			if (player != null)
			{
				base.Body.MoveTo(player.X + 250, player.Y, "walk", 1000, "", 10, new LivingCallBack(this.method_1));
			}
		}
		...
		private void method_1()
		{
			...
			base.Body.CallFuction(new LivingCallBack(this.zBkhgtlOepb), 4500);
		}
		...
		{
			base.Body.PlayMovie("beatC", 700, 0);
			base.Body.CallFuction(new LivingCallBack(this.method_3), 3200);
		}
		...
		private void method_3()
		{
			...
			if (this.player_0 != null)
			{
				...
				this.physicalObj_0 = ((PVEGame)base.Game).Createlayer(this.player_0.X, this.player_0.Y, "moive", "asset.game.eleven.064", "out", 1, 1);
		...
		public override void OnStartAttacking()
		{
			...
			if (flag)
			{
				this.snQhgwmuirW(base.Body.X - 150, base.Body.X + 150);
				return;
			}
			if (this.int_0 == 0)
			{
		...
		private void snQhgwmuirW(int int_1, int int_2)
		{
