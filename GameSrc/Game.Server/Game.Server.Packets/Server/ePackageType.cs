...
{
    public enum EliteGamePackageType
    {
        ELITE_MATCH_TYPE = 1,
        ELITE_MATCH_RANK_START = 2,
        ELITE_MATCH_PLAYER_RANK = 3,
        ELITE_MATCH_RANK_DETAIL = 4,
    }
    public enum ePackageType
    {
        ...
        EQUIP_GHOST = 391,
        EQUIP_BRING_UP = 308,
        ITEM_CELL_IS_LOCKED = 313,
        STORE_FINE_SUIT = 295,
        WONDERFUL_ACTIVITY = 159,
        WONDERFUL_GETREWARD = 373,
        WONDERFUL_ACTIVITY_INIT = 405,
        CONSUME_RANK = 351,
        RECHARGE_RANK = 352,
        FIGHT_POWER_RANK = 353,
        LEVEL_RANK = 354,
        ONLINE_RANK= 355,
        WIN_RANK = 356,
        LABYRINTH = 131,
