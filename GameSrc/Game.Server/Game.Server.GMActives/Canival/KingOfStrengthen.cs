...
{
    public class KingOfStrengthen : IGMActive
    {
        public KingOfStrengthen(GmActivityInfo gmActive, List<UserGmActivityInfo> listUsersGmInfo) : base(gmActive, listUsersGmInfo)
        {
        }
        ...
        {
            GmActivityMgr.StrenghUp += GmActivityMgr_StrenghUp;
        }

        private void GmActivityMgr_StrenghUp(GamePlayer player, int value)
        {
