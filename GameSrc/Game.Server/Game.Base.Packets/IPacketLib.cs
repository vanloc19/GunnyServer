...
namespace Game.Base.Packets
{
	public interface IPacketLib
	{
        ...
        GSPacketIn SendUserEquip(PlayerInfo player, List<ItemInfo> items, List<UserGemStone> userGemStone, ExplorerManualInfo explorerInfo);
		...
		GSPacketIn SendSingleRoomCreate(BaseRoom room, GamePlayer player);
		...
		GSPacketIn SendAvatarColectionAllInfo(int PlayerId, Dictionary<int, UserAvatarColectionInfo> infos);

		void SendUpdateChickActivation(UserChickActiveInfo chickInfo);

		void SendLoginChickActivation(UserChickActiveInfo chickInfo);

		GSPacketIn SendInviteFriends(PlayerInfo player, int type);
