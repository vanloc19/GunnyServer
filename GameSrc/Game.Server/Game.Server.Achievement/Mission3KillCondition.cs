...
{
	public class Mission3KillCondition : BaseUserRecord
	{
		public Mission3KillCondition(GamePlayer player, int type)
			: base(player, type)
		{
			AddTrigger(player);
		}
		...
		{
			if (game.GameType == eGameType.Dungeon && !isLiving && type == 2 && (id == 3017 || id == 3117 || id == 3217 || id == 3317))
			{
