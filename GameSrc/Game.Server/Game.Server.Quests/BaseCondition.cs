	...
	public class BaseCondition
	{
		...
		public static BaseCondition CreateCondition(BaseQuest quest, QuestConditionInfo info, int value)
		{
			switch (info.CondictionType)
			{
				...
				case 26:
					return new MarryCondition(quest, info, value);//Fight Marry
				case 27:
					return new EnterSpaCondition(quest, info, value);
				case 28:
					return new FightWifeHusbandCondition(quest, info, value);//Fight Win Marry
				case 29:
				...
				case 101:
					return new GameFight3VS3Condiction(quest, info, value);
				case 102:
					return new PlayerOnlineSpaCondiction(quest, info, value);
				case 103:
					return new PlayerLoginDeviceCondiction(quest, info, value);
				case 104:
					return new GameMissionOverByTimesCondition(quest, info, value);
				case 105:
					return new GameFight4VS4Condiction(quest, info, value);
				case 106:
				case 55:
					return new UpLevelVipCondition(quest, info, value);
				case 107:
					return new WorldBossFightCondiction(quest, info, value);
				case 108:
					return new NPCDamageCondition(quest, info, value);
				default:
					if (log.IsErrorEnabled)
                    {
						log.Error((object)$"Can't find quest condition : {info.CondictionType}");
					}
