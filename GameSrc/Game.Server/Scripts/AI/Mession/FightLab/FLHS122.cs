...
namespace GameServerScript.AI.Messions
{
	public class FLHS122 : AMissionControl
	{
		...
		public override void OnPrepareNewGame()
		{
			...
			int num = -1;
			int num2 = 0;
			for (int i = 0; i < rmRcwwyrPeq; i++)
			{
				do
				{
					num2 = base.Game.Random.Next(3, 20);
					int_5[i] = (num2 + 1) * 100 + 75;
				}
				while (num2 == num);
				num = num2;
			}
		...
		{
			if (int_0 <= rmRcwwyrPeq)
			{
				if (bool_1)
				{
					simpleNpc_0 = base.Game.CreateNpc(int_4, 1075, 515, 2, -1, base.Game.BaseLivingConfig());
				...
				{
					simpleNpc_0 = base.Game.CreateNpc(int_4, int_5[int_3], 515, 2, -1, base.Game.BaseLivingConfig());
					simpleNpc_0.Config.IsTurn = false;
					int_0++;
					int_3++;
					base.Game.WaitTime(0);
