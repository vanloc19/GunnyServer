...
namespace GameServerScript.AI.Messions
{
	public class WAS13002 : AMissionControl
	{
		...
		private PhysicalObj nOrYsjVbEcM;
		...
		public override void OnShooted()
		{
			...
			if (this.simpleBoss_0 != null && !this.simpleBoss_0.IsLiving)
			{
				...
				this.simpleBoss_0.CallFuction(new LivingCallBack(this.QrlYshMpygO), waitTimerLeft);
			}
		}
		...
		{
			base.OnStartGame();
			this.nOrYsjVbEcM = base.Game.Createlayer(1150, 1041, "normal", "asset.game.ten.zhuzi", "1", 1, 0);
		...
		private void QrlYshMpygO()
		{
			...
			this.simpleNpc_0.CallFuction(new LivingCallBack(this.method_2), 7700);
			...
			this.simpleBoss_1.CallFuction(new LivingCallBack(this.method_3), 13700);
		}
