...
{
	public class WAH13203 : AMissionControl
	{
		private int int_0;
		...
		private SimpleBoss WkcYezrvljT;
		...
		{
			base.CanGameOver();
			if (this.WkcYezrvljT != null && !this.WkcYezrvljT.IsLiving)
			{
				return true;
			}
		...
		private void method_0()
		{
			...
			this.simpleBoss_0 = base.Game.CreateBoss(this.int_1, 1683, 762, -1, 1, "", livingConfig);
		...
		public override void OnStartGame()
		{
			...
			this.WkcYezrvljT = base.Game.CreateBoss(this.int_0, 1683, 1012, -1, 1, "");
			this.WkcYezrvljT.SetRelateDemagemRect(this.WkcYezrvljT.NpcInfo.X, this.WkcYezrvljT.NpcInfo.Y, this.WkcYezrvljT.NpcInfo.Width, this.WkcYezrvljT.NpcInfo.Height);
			base.Game.SendObjectFocus(this.WkcYezrvljT, 0, 0, 0);
			this.WkcYezrvljT.CallFuction(new LivingCallBack(this.method_0), 2000);
		}
