...
namespace GameServerScript.AI.NPC
{
	public class ThirteenSimpleAntBoss : ABrain
	{
		...
		public ThirteenSimpleAntBoss()
		{
			...
			this.UlosOgpdKaT = new string[] { "Băng trâm tiễn.", "Liếm thử băng trâm tiễn của ta", "Để ta giúp ngươi về trời nhanh." };
		...
		{
			int num = base.Game.Random.Next(0, (int)this.UlosOgpdKaT.Length);
			base.Body.Say(this.UlosOgpdKaT[num], 0, 1000, 0);
		...
		private void method_4(List<Player> WeGjyHCVui6nVDiS4xh)
		{
			...
			foreach (Player weGjyHCVui6nVDiS4xh in WeGjyHCVui6nVDiS4xh)
			{
				base.Body.BeatDirect(weGjyHCVui6nVDiS4xh, "", 2500, 1, 1);
			}
		}
