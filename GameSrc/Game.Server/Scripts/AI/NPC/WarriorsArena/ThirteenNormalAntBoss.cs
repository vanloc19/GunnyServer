...
namespace GameServerScript.AI.NPC
{
	public class ThirteenNormalAntBoss : ABrain
	{
		...
		private void method_4(List<Player> V1UHLJVJA395290abmO)
		{
			base.Body.CurrentDamagePlus = 1000f;
			base.Body.PlayMovie("beatB", 1000, 0);
			foreach (Player v1UHLJVJA395290abmO in V1UHLJVJA395290abmO)
			{
				base.Body.BeatDirect(v1UHLJVJA395290abmO, "", 2500, 1, 1);
			}
		}
