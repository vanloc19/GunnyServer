...
{
	public class ThirteenSimpleShadowBoss : ABrain
	{
		private int int_0;
		...
		private string[] HecsVtjkiPK;

		private string[] string_1;

		private string[] NgNsVudYgCe;

		private int int_2;

		public ThirteenSimpleShadowBoss()
		{
			...
			this.HecsVtjkiPK = new string[] { "Liệu có đỡ nổi không đây?", "Ta sẽ giết từng đứa một", "Trước kia bọn ngươi còn củ hành bọn ta. Giờ thì đừng hòng.", "Ngươi sẽ là mục tiêu ta giết đầu tiên", "Liệu ngươi đỡ được không đây?" };
			this.string_1 = new string[] { "Lũ tép diu các ngươi phải chết hết", "Đừng mơ thắng được ta", "Ngươi nghĩ ngươi đánh bại được AD đẹp zai à?", "Ad éo cho ngươi qua đâu. Ahahaa...", "Đậu xanh ta giết tất cả" };
			this.NgNsVudYgCe = new string[] { "Ta chịu hết nổi rồi", "Mọe chứ chơi lại chiêu cũ. Chết chùm luôn", "Ta chết các ngươi cũng phải chết.", "Lũ cờ hó ta chịu mếu nổi rồi", "Đùa đủ rồi. Chết hết. Giết hết" };
		...
		{
			int num = base.Game.Random.Next((int)this.HecsVtjkiPK.Length);
			base.Body.Say(this.HecsVtjkiPK[num], 0, 1000);
