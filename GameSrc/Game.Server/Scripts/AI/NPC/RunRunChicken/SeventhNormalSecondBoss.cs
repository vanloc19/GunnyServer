...
namespace GameServerScript.AI.NPC
{
	public class SeventhNormalSecondBoss : ABrain
	{
		...
		private void method_6()
		{
			if (m_targer != null)
			{
				((SimpleBoss)base.Body).RandomSay(string_0, 0, 50, 0);
		...
		private void method_9()
		{
			if (m_targer != null)
			{
				physicalObj_0 = ((PVEGame)base.Game).Createlayer(m_targer.X, m_targer.Y, "", "asset.game.seven.choud", "", 1, 1);
				physicalObj_1 = ((PVEGame)base.Game).Createlayer(m_targer.X, m_targer.Y, "", "asset.game.seven.du", "", 1, 1);
		...
		public SeventhNormalSecondBoss()
		{
		...
		static SeventhNormalSecondBoss()
		{
