...
namespace GameServerScript.AI.NPC
{
	public class ThirdTerrorKingFirst : ABrain
	{
		...
		private void method_6()
		{
			...
			base.Body.Say(string_1[num], 0, 2000);
		...
		private void method_8()
		{
			...
			base.Body.Say(string_0[num], 0, 2300);
		...
		static ThirdTerrorKingFirst()
		{
			...
			string_1 = new string[4]
			{
				...
				"Thấy mệt mỏi chưa?",
				"Vũ nữ đâu cho tụi nó kiệt sức đi"
			};
			string_2 = new string[4]
			{
				"Sao mà bắn ta được?",
				"Giỏi thì thử bắn nữa đi.",
				"Mọe bắn hoài. Giờ khỏi bắn nhé",
				"Ta éo phải cái bia cho ngươi bắn"
			};
