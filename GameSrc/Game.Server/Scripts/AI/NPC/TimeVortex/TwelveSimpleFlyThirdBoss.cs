...
namespace GameServerScript.AI.NPC
{
    public class TwelveSimpleFlyThirdBoss : ABrain
    {
        ...
        private void BeatD()
        {
            Body.Say("Ìíå åù¸ íå ïîïàäàëîñü ïðîòèâíèêà ñèëüíåå!", 0, 100, 2000);
        ...
        private void PreBeatB()
        {
            ...
            Body.Say("Çíàåøü ÷òî òàêîå ñèëà òîêà? Ñåé÷àñ óçíàåøü!", 0, 100, 2000);
        ...
        private void BeatC()
        {
            Body.Say("Ñêîðî ÿ áóäó ïðàâèòü ìèðîì!", 0, 100, 2000);
        ...
        private void BeatA()
        {
            Body.Say("Íå çëèòå ìåíÿ!!!", 0, 100, 2000);
        ...
        private void CreateFengyinffect()
        {
            ...
            if (players.Count == 1)
            {
                ...
                ((PVEGame)Game).SendPlayersPicture(players[0], 7, true);
        ...
        private void StopRotatePlayers()
        {
            ...
            {
                player.BoltMove(player.X, 910, 3000);
                Game.LivingChangeAngle(player, 0, 0, "");
            }
        }
